---
data: 2026-08-13
titulo: "Quinta-feira 13/08 completa a primeira semana cheia de pregão (5 sessões: 07→13/08) sem nenhum dado novo, e o forecast estatístico de 7 dias gerado em 06/08 vence hoje sem nunca ter sido confrontado com um fechamento real — enquanto os mesmos 4 pregões genuinamente conhecidos (03→06/08) continuam mostrando farelo ganhando força relativa no crush (oil-meal spread -5,4% acumulado) e óleo travado sob a quebra técnica (67,60 vs suporte 72,00)"
tags: [complexo, auto-claude]
fontes:
  - CME CBOT (ZSU26 soja / ZMU26 farelo / ZLU26 óleo) — sessão de 2026-08-06 (quinta-feira), a MESMA sessão já usada nas leituras de 2026-08-07 a 2026-08-12; hoje é quinta-feira 2026-08-13, quarto dia útil pleno seguido (e quinto pregão represado no total) sem nenhum carimbo novo — ver Honestidade
  - CME CBOT — série completa dos últimos 4 pregões genuinamente conhecidos (2026-08-03, 08-04, 08-05, 08-06), usada nesta leitura para tendência multi-sessão, sem nenhum ponto adicional desde a leitura de ontem
  ...
  - BCB PTAX — carimbo mais recente 2026-08-05 (USD/BRL 5,1154); agora 8 dias corridos sem atualização
  - CEPEA/ESALQ Soja Paranaguá via NAG — carimbo mais recente 2026-08-05, R$ 144,91/saca; 8 dias sem atualização
  - CEPEA/ESALQ Soja Paraná interior via NAG — carimbo mais recente 2026-08-05, R$ 136,73/saca
  - NAG Físico BR — carimbo mais recente 2026-08-05 (farelo MT/IMEA R$ 1.675,10/ton, congelado há 13 dias desde 31/07; Rondonópolis/MT R$ 1.700,00/ton, mesmo congelamento; RS R$ 1.800,00/ton, agora 8 dias sem segunda leitura de confirmação); prêmios export PGUA farelo (+0,05 USD/sht) e óleo (+0,08 cts/lb), carimbo 2026-08-05, "mês Agosto/26"
  - CFTC COT Managed Money, Swap Dealers e Producer/Merchant — corte de 2026-07-28, agora 16 dias sem atualização — mais que o dobro do ciclo semanal normal
  - USDA Crop Progress — corte rotulado 2026-08-02, mesmos valores do corte de 2026-07-26 (11% excelente / 52% boa / 7% ruim), décima leitura seguida sem mudança
  - USDA WASDE — ausente da janela, agora 34 dias de atraso desde o último dado (2026-07-10)
  ...
  - Forecasts estatísticos internos (bandas 7d/30d, MA20+volatilidade+slope) — geração mais recente 2026-08-06; a banda de 7 dias tem alvo em 2026-08-13, ou seja, HOJE, e nenhum ponto de dado surgiu na janela inteira para testá-la
  - system/tributario_watch.toml (lido como referência, não editado) — `atualizado_em` 2026-06-05, agora 69 dias sem atualização
  ...
  - Cruza com [[2026-08-12_leitura-complexo]], [[2026-08-11_leitura-complexo]], [[2026-08-10_leitura-complexo]], [[2026-08-09_leitura-complexo]] e [[2026-06-11_ratio-81-prepara-janela-de-tranches-farelo]] (tese original do D+7, checkpoint segue vencido)
status: ativa
...
**Hoje é quinta-feira, 2026-08-13, e o fato mais importante desta leitura,
pela sétima vez consecutiva, continua sendo estrutural, não de mercado — mas
hoje esse fato cruza um limiar novo e simbolicamente redondo: o briefing lido
hoje ainda traz o fechamento de quinta-feira, 2026-08-06, exatos SETE DIAS
CORRIDOS atrás, como o dado mais recente de CBOT, PTAX, físico NAG, COT e
RSS.** A leitura de ontem (12/08) já havia registrado a primeira semana útil
inteira sem carimbo novo (sexta 07, segunda 10, terça 11 e a própria
quarta 12). **Hoje esse hiato ganha uma quinta sessão real ausente — sexta
07/08, segunda 10/08, terça 11/08, quarta 12/08 e a própria quinta 13/08 de
hoje —, o que significa que uma SEMANA INTEIRA DE PREGÃO (cinco sessões
completas, o número de dias úteis que a CBOT abriria numa semana normal) se
perdeu por completo, e o calendário voltou exatamente ao mesmo dia da semana
(quinta-feira) em que o último dado real foi registrado.** Esse fechamento
de ciclo semanal — quinta a quinta, sete dias corridos exatos — é o motivo
para tratar hoje como um marco qualitativo novo, e não apenas "mais um dia de
hiato": a partir de agora, qualquer novo ponto de dado que apareça retroativo
não estará mais competindo com "alguns dias perdidos", mas com uma semana
cheia de notícia, câmbio, posicionamento e fechamento potencialmente
acumulados. Some-se a isso um segundo marco que se fecha justamente hoje: o
forecast estatístico interno de 7 dias, gerado em 2026-08-06 com alvo
explícito em 2026-08-13 (bandas soja "baixista" 1.098,32-1.204,99; farelo
"lateral" 298,41-322,58; óleo "baixista" 61,96-70,41), tinha até hoje para
ser testado contra um fechamento real — e, com o hiato total, essa banda
específica vence sem nunca ter sido confrontada com nenhum dado, o primeiro
forecast desta série inteira a expirar completamente "no escuro". Esta
leitura mantém o tratamento desse achado estrutural como o mais acionável do
dia, à frente de qualquer conclusão sobre preço — ver Honestidade para o
detalhamento completo e a recomendação de verificação técnica direta, agora
com a prioridade mais alta de toda a série, dado que o hiato alcançou uma
semana cheia de pregão e um forecast formal expirou sem teste.
...
identificada nas seis leituras anteriores, e que esta análise aprofunda mais
uma vez porque é, literalmente, o único material novo disponível para
...
100/100 — não mudam há pelo menos 13 dias corridos (desde 31/07 até o carimbo
de 06/08, e sem novo carimbo desde então), porque medem condições de
...
de um lado, a lacuna de dado completou uma semana cheia de pregão e um
forecast formal expirou sem jamais ter sido testado, o marco estrutural mais
forte desta série inteira; do outro, a única informação de mercado
disponível, lida em janela de 4 sessões em vez de 1 dia, continua mostrando
farelo ganhando força tática dentro do crush enquanto o óleo aprofunda uma
quebra técnica estrutural — maior convicção nos mecanismos estruturais (ISF,
ISO, ABIOVE) que independem do calendário, confiança moderada na tendência
tática de 4 sessões (o mesmo conjunto de pontos de dado das últimas seis
leituras, sem nenhum ponto novo para reforçá-la ou refutá-la), e confiança
mínima — a mais baixa desta série inteira, superando novamente a de ontem —
sobre o que efetivamente aconteceu com o preço entre a tarde de 06/08 e
agora, um hiato que já soma 7 dias corridos e 5 sessões reais de mercado.
...
sessões (03→06/08, -1,39% acumulado) — a mesma leitura híbrida das seis
análises anteriores, agora com mais um dia de gap que segue sem permitir
confirmar nem descartar nenhuma das duas hipóteses.** Último fechamento
...
resolveu — e hoje, quinta-feira, já deveriam ter existido pelo menos QUATRO
novas sessões (sexta, segunda, terça e quarta, além da própria quinta de
hoje) para testar isso, e não existe nenhuma.** Abertura 1.157,25, máxima
1.158,50, mínima 1.155,75, fechamento 1.157,50 — amplitude de apenas 2,75
pontos, um quarto dos 13,00 pontos do pregão anterior (05/08). **Mecanismo:**
compressão de amplitude tende, em teoria técnica de mercado, a preceder um
movimento mais amplo quando aparece o catalisador — e agora há CINCO
catalisadores represados que não chegaram (o COT da semana de 04/08, que
normalmente sairia numa sexta; o COT da semana de 11/08, que também já
deveria ter saído; a reabertura de segunda-feira 10/08; e as sessões de
terça 11/08, quarta 12/08 e a própria quinta 13/08 de hoje), o que reforça
ainda mais a hipótese de represamento técnico sem, no entanto, confirmá-la —
a confirmação só existe quando o pregão real voltar a aparecer no briefing.
...
quase 2 semanas corridas) seja pequena para qualificar como tendência forte.
Com uma semana inteira adicional de silêncio, essa magnitude relativamente
pequena passa a carregar um risco extra: se o mercado tiver, de fato,
continuado a ceder nos cinco pregões represados na mesma velocidade média
observada nos últimos três pregões de queda (cerca de -0,5% por sessão), a
soja poderia, hipoteticamente, já estar bem abaixo de 1.140 no momento em
que o pregão real reaparecer — um exercício puramente ilustrativo, não uma
previsão, que serve apenas para mostrar por que o tamanho do hiato já importa
para o dimensionamento de risco.
...
anterior (54,50 em 05/08). Sem sessão de sexta, segunda, terça, quarta ou
hoje, esta leitura não tem como saber se esse formato persistiu — e,
relevante para quem monitora spreads de calendário, cinco pregões represados
significam que qualquer ajuste de curva que tenha ocorrido no intervalo pode
aparecer de uma vez, como um salto maior do que o normal, na próxima sessão
real, em vez de gradualmente distribuído ao longo de uma semana inteira.

**O câmbio permanece com o mesmo carimbo de quarta-feira (05/08), agora há 8
dias sem atualização — mas a série das duas semanas anteriores ao hiato
...
câmbio dos últimos cinco pregões represados não está capturado neste número
— e, como o USD/BRL é o canal mais direto entre o CBOT em dólares e o preço
físico em reais, essa é, junto com o próprio CBOT, a lacuna mais relevante
para quem decide originação ou hedge cambial hoje.
...
caindo, não subindo, nas últimas 2 semanas.** A manchete "Soja em Mato
Grosso atinge maior preço do ano, mas indústria enfrenta desafios" (Canal
Rural, 06/08/2026) segue sem corpo de texto nem número (`headline: None`).
O preço de suporte CEPEA/ESALQ em Paranaguá (via NAG) mostra queda ao longo
das últimas 2 semanas: de R$ 148,37/saca (24/07) para R$ 144,04/saca (03/08)
— -2,92% em 8 pregões — antes de recuperar levemente para R$ 144,91/saca
(05/08, carimbo mais recente, agora 8 dias parado). **Mecanismo:**
compatível com dois cenários que esta leitura não consegue distinguir sem
mais dado: (1) a manchete se refere ao mercado *interior* de Mato Grosso,
onde custo/frete e demanda da própria indústria local podem estar
dissociados do preço de exportação — coerente com "indústria enfrenta
desafios" (margem de esmagamento local apertando mesmo com FOB porto
estável ou em leve queda); ou (2) a manchete usa métrica ou data-base
diferente da série CEPEA/NAG. No último dia comparável (05/08), a soja em
Paranaguá (R$ 144,91/saca) pagava um prêmio de **+10,94%** sobre a paridade
teórica (R$ 130,62/saca, indicators). Recomendação mantida: não tratar a
manchete como driver quantitativo sem número verificável em fonte primária.

**O posicionamento do COT (CFTC) segue no corte de 28/07/2026, agora 16
...
qualquer queda. O corte tem agora 16 dias — mais de dois ciclos semanais
completos sem renovação. Já deveriam ter saído, no mínimo, dois cortes novos
(nominalmente 07/08 e 14/08 está a apenas 1 dia); o dado mais urgente desta
janela para reavaliar se essa concentração ainda existe.

### O que invalida / risco para a soja

- **As sessões represadas (07, 10, 11, 12 e 13/08) aparecerem retroativamente
  num briefing futuro** fora do range de 1.155,75-1.158,50 — romperia a
...
- **O WASDE finalmente voltar a ser publicado** (34 dias de atraso).

### Leitura operacional — soja

Para quem opera os dois lados, a lacuna de dado hoje é, mais uma vez, a
informação operacional mais relevante: cinco pregões reais represados
(sexta, segunda, terça, quarta e a própria quinta de hoje) — uma semana
cheia de pregão — aumentam ainda mais a probabilidade de um movimento de
abertura amplo quando o pregão realmente voltar a ser refletido no
briefing — mais tempo, mais notícia potencialmente acumulada (COT, RSS,
câmbio) para o mercado digerir de uma só vez, e agora com uma janela maior
que qualquer uma desta série. A leitura de tendência de 4 sessões (-1,39%)
sugere viés ligeiramente baixista de curtíssimo prazo, mas com convicção
baixa — a magnitude é pequena e o hiato de dados, agora o maior desta série,
pede cautela extra antes de dimensionar posição nova. A concentração de
...
posicionamento — e, com cinco pregões represados, o primeiro pregão real
após o hiato é o candidato mais provável para esse tipo de movimento amplo.
...
confirmar ou reverter — e a lacuna de hoje agora soma quatro dias úteis
seguidos em que essa quinta confirmação deveria ter chegado e não chegou, o
que torna esse o sinal mais "represado" de toda a leitura.** Trata
...
### O D+7 chega a 56 dias vencido — e o ratio nunca fechou abaixo de 80% no período recente
...
formal (D+7) caiu em 18/06/2026; hoje, 13/08/2026, são **56 dias corridos**
...
zona. O próximo marco formal é o D+90 (2026-09-09), agora a **27 dias**.
...
agora represado por quatro dias úteis inteiros.** 0,6281 USD/bu (03/08) →
...
análises de 08/08 a 12/08: tendência tática em desenvolvimento, ainda não
confirmada por dado que dependa de uma quinta sessão real — que já deveria
ter existido quatro vezes (segunda, terça, quarta e hoje) e ainda não
existe.
...
deste briefing (pelo menos 31/07 a 06/08, ou seja, 13 dias corridos sem um
único carimbo diferente), sem novo carimbo hoje porque não há sessão
nova.** As projeções ABIOVE seguem, sem alteração, mostrando a exportação
de farelo brasileiro caindo de 1.400 mil toneladas em agosto/2026 para 700
mil toneladas em dezembro/2026 (-50% em quatro meses, ABIOVE projeções
mensais) e o esmagamento mensal projetado caindo de 2.827 mil t em setembro
para 2.204 mil t em dezembro (-22%) — drivers estruturais de mais longo
prazo que independem completamente do calendário de pregões, e por isso
continuam sendo a parte mais sólida desta leitura de farelo.

**Prêmio de exportação em Paranaguá permanece perto de zero, carimbo de
2026-08-05, agora 8 dias sem atualização.** +0,05 USD/short ton, "mês
...
05/08.** Mato Grosso/IMEA congelado em R$ 1.675,10/ton **há 13 dias** (desde
...
**segue sem uma segunda leitura de confirmação, agora há 8 dias**. Quanto
mais tempo passa sem segunda leitura, maior o peso da ressalva de que pode
ser anomalia de coleta, não um novo nível de preço confirmado — 8 dias sem
confirmação já justifica, na visão desta leitura, contato direto com a
praça em vez de aguardar mais um dump.
...
- **O ratio Far/Soj finalmente fechar abaixo de 80%** após 56 dias sem
...
deveria ter chegado quatro vezes, segunda, terça, quarta e hoje — continua
ausente, o que efetivamente congela a decisão por mais um dia útil inteiro,
agora completando uma semana cheia sem confirmação possível. A recomendação
operacional segue a mesma das leituras anteriores, com peso adicional dado
o tamanho do hiato: aguardar a próxima sessão real antes de ajustar tamanho
de posição no spread Far/Soj, e considerar que, quando essa sessão chegar,
ela carrega potencialmente cinco pregões de mercado represado, o que pode
produzir um movimento de abertura maior do que o normal em qualquer direção.
Para quem opera o físico de farelo no RS, a recomendação permanece: não
tratar R$ 1.800,00/ton como preço de mercado confirmado sem uma segunda
leitura, e considerar contato direto com a praça dado que já são 8 dias
sem confirmação via o dado público.
...
sem nenhum dado novo hoje, pelo quarto dia útil seguido, para testar se o
movimento continuou, estabilizou ou reverteu.** Trata
...
de sessão nova por já cinco pregões reais represados.
...
mantém essa interpretação como hipótese de trabalho, agora há cinco
pregões sem poder testá-la.
...
(pelo menos 31/07 a 06/08, 13 dias corridos sem mudança).** A tese
estrutural (óleo dominando o valor do crush) segue formalmente intacta como
último retrato conhecido, coexistindo sem contradição técnica com o preço
em tendência de baixa e a curva cada vez mais invertida — o ISO mede quem
captura valor dentro do crush, não se o preço está caro ou barato frente a
um nível técnico.
...
recente, agora 16 dias velha, e olhando as 3 categorias juntas, o óleo é a
...
categoria. Com 16 dias de idade, esse corte é o dado de posicionamento mais
...
cinco pregões reais represados (sexta 07/08, segunda 10/08, terça 11/08,
quarta 12/08 e a própria quinta 13/08), a primeira sessão real após o hiato
carrega risco elevado de gap de abertura em qualquer direção, o que muda a
mecânica prática de onde e como esse stop deveria estar posicionado (um
stop lógico numa cotação intradiária pode não capturar um gap que abre
diretamente acima ou abaixo do nível). A leitura de que o aprofundamento da
backwardation vinha do fim da curva, não do início, continua relevante para
quem opera spreads de calendário — estruturas que vendem os vencimentos mais
distantes contra os próximos (vende F27/H27, compra Q26/U26) seguem
coerentes com o último dado disponível, mas carregam agora sete dias
corridos de risco de gap (sexta que faltou + fim de semana + segunda + terça
+ quarta + hoje) sem atualização de preço para reavaliar. Para quem
considera nova posição comprada, a posição residual dos swap dealers (net
long ~88.407 contratos, sem sinal de redução no último corte) é argumento de
cautela adicional: ainda há posição especulativa "gorda" que pode ser
...
agora 56 dias vencida.** A recomendação operacional permanece: exigir
...
ausente pelo quarto dia útil seguido, essa confirmação segue impossível de
obter.
...
**ISF em 80/100, ISO em 100/100 — ambos inalterados por pelo menos 13 dias
corridos (desde 31/07), e ambos continuam sendo a parte mais sólida desta
leitura: são índices estruturais que não "pausam" quando o mercado não
abre.** As projeções ABIOVE de esmagamento mensal (2.827 mil t em setembro
caindo para 2.204 mil t em dezembro, -22%) seguem reforçando o pano de
fundo de menor oferta futura de farelo e óleo no Brasil.
...
é a tensão mais relevante do complexo nesta leitura. Com cinco pregões
reais represados — a primeira semana cheia de pregão sem dado novo desta
série — essa tensão fica sem teste novo por mais um dia: a próxima sessão
real, sempre que o pipeline voltar a rodar, decide se o sinal tático do
farelo se firma ou se dissolve, e chega carregando o peso extra de uma
semana inteira de mercado potencialmente represado.
...
`vigencia_ate` 2026-07-31) — hoje, 2026-08-13 (quinta-feira), completa o
9º dia útil desde o vencimento** (dias úteis decorridos: 03, 04, 05, 06, 07,
10, 11 e 12, mais o próprio dia de hoje). Nenhum item do RSS desde 06/08
trouxe informação sobre este tema, e o monitor tributário
(`system/tributario_watch.toml`) segue parado desde 2026-06-05 — **69 dias
...
última leitura disponível. Com quase duas semanas de pregões (03 a 07/08,
mais 10, 11, 12 e hoje 13/08) transcorridas sem confirmação, este item
permanece, nesta leitura, a verificação manual mais urgente do conjunto
fiscal — o tempo decorrido só cresce a cada dia útil sem checagem direta.

**MP 1.358/2026 — subvenção à gasolina (R$ 0,89/L) e diesel (R$ 0,35/L) —
vigência formal venceu há 33 dias** (`vigencia_ate` 11/07/2026), sem
...
plena prevista para 01/09/2026, agora a **19 dias**); INDONESIA-B50
...
**O monitor tributário como um todo está há 69 dias sem qualquer
atualização** — prioridade de manutenção do sistema, especialmente relevante
agora que a isenção PIS/Cofins acumula 9 dias úteis sem confirmação de
status.
...
do mercado — e a gravidade aumentou de novo, cruzando pela primeira vez a
marca de uma semana COMPLETA de pregão (5 sessões) sem nenhum dado.** Sexta
07/08, segunda 10/08, terça 11/08, quarta 12/08 e a própria quinta 13/08 de
hoje estão ausentes do briefing, e o job que gera `briefing/latest.md`
parece não ter rodado desde 05→06/08, agora 7 dias corridos exatos —
recomendação de verificação técnica direta, com a prioridade mais alta de
toda a série, antes de tratar qualquer gap de preço na próxima abertura
refletida como movimento de mercado genuíno, e não como acúmulo de uma
semana inteira de notícia processada de uma vez.

**O forecast estatístico interno de 7 dias, gerado em 2026-08-06 com alvo
em 2026-08-13, vence exatamente HOJE sem nunca ter sido confrontado com um
único fechamento real** — a banda (soja "baixista" 1.098,32-1.204,99;
farelo "lateral" 298,41-322,58; óleo "baixista" 61,96-70,41) expira sem
qualquer teste, o primeiro caso desta série inteira em que uma previsão
formal do sistema simplesmente vence "no escuro", sem nenhum ponto de dado
novo em toda a sua janela de vigência.

**O COT (CFTC) referente a 04/08/2026 segue ausente, agora 16 dias desde o
...
corte de 18/08 a apenas 5 dias.** Quando o dado chegar, o ponto mais
...
tese do D+7 (agora 56 dias vencida), ou se rompe para baixo, confirmando-a
com atraso.
...
**A isenção PIS/Cofins do biodiesel completa hoje o 9º dia útil sem
...
leitura de confirmação, agora há 8 dias** — recomendação de contato direto
com a praça.

**O USDA Crop Progress rotulado 2026-08-02 segue com os MESMOS valores do
corte de 26/07**, agora pela décima leitura seguida; o próximo corte,
referente à semana de 09/08, já deveria ter saído.
...
**O WASDE segue fora da janela deste briefing, agora 34 dias de atraso**
desde o último dado (10/07/2026).

**Danantara (Indonésia) assume plenamente a cadeia de exportação de palma
em 01/09/2026, a 19 dias de hoje** — monitorar se a curva do óleo CBOT
...
recente é de 2026-08-06 (lido em 2026-08-13), e os pontos onde a confiança
é baixa:

**1. O achado central desta leitura, agora pela sétima vez seguida e com
uma nova mudança de natureza qualitativa: nenhuma fonte do briefing trouxe
dado novo desde a sessão de 2026-08-06 — nem CBOT, nem PTAX, nem NAG físico,
nem COT, nem RSS, nem INMET, nem ENSO, nem MPOB, nem BCBA.** Na leitura de
ontem (12/08), o hiato já somava quatro pregões reais perdidos e fechava a
primeira semana útil inteira sem dado. **Hoje, quinta-feira 13/08, o hiato
soma cinco sessões reais consecutivas ausentes — sexta 07/08, segunda 10/08,
terça 11/08, quarta 12/08 e a própria quinta 13/08 de hoje —, e o
calendário completa exatos SETE DIAS CORRIDOS desde o último dado (quinta a
quinta), o equivalente a uma semana cheia de mercado (todas as sessões que
a CBOT abriria numa semana normal) perdida por completo.** O padrão —
ausência total e uniforme em todas as fontes, não apenas na CBOT, e agora
persistente por quatro dias úteis consecutivos (segunda, terça, quarta e
quinta) — é incompatível com qualquer hipótese de atraso pontual de uma
única fonte, e aponta com a convicção mais alta desta série inteira para o
job que gera `briefing/latest.md` não ter rodado desde a noite de 05→06/08.
Esta leitura recomenda, pela sétima vez e agora com a prioridade mais alta
de toda a série, verificação técnica direta do pipeline de coleta
(`main.py` / scraper CME / agendador do job) antes de mais um ciclo de
leitura ser gerado sobre o mesmo dado de 06/08 — o custo de continuar
reprocessando a mesma sessão cresce a cada dia que passa sem essa
verificação, e hoje esse custo ganhou um componente novo e concreto: o
forecast estatístico de 7 dias gerado nesta mesma base (06/08) tinha o seu
próprio alvo em 2026-08-13 — precisamente hoje — e expira, deste modo, sem
jamais ter sido testado contra um único fechamento real.
...
classificação não pôde avançar desde a leitura de 12/08.
...
recente, agora 16 dias sem atualização — mais que o dobro do intervalo
...
(managed money + swap dealers) usa dado de mais de duas semanas de idade —
pode já estar desatualizada, especialmente se um catalisador de mercado
tiver ocorrido nos cinco pregões represados.

**5. O prêmio de exportação de Paranaguá (soja) e o CEPEA Paraná interior
não trouxeram carimbo novo desde 2026-08-05** — agora 8 dias sem
atualização.
...
incluindo qualquer variação dos últimos cinco pregões represados.
...
**10. O ratio Far/Soj (80,60%) segue sem fechar abaixo de 80%, agora 56
...
D+90 (2026-09-09, a 27 dias) como próximo marco formal.

**11. O USDA Crop Progress rotulado 2026-08-02 trouxe, pelo décimo dump
...
(semana de 09/08, que já deveria ter sido publicado).

**12. A isenção PIS/Cofins do biodiesel — sem confirmação de renovação ou
caducidade neste briefing, completando hoje o 9º dia útil sem status.** O
monitor tributário está 69 dias sem atualização; esta leitura não presume
nenhum dos dois cenários.

**13. O WASDE permanece completamente fora da janela deste briefing** —
agora 34 dias de atraso desde o último dado (10/07/2026).
...
**18. O forecast estatístico interno de 7 dias (gerado em 2026-08-06, alvo
2026-08-13) venceu HOJE sem nunca ter sido testado contra um fechamento
real — o primeiro forecast desta série inteira a expirar completamente "no
escuro".** As bandas (soja 1.098,32-1.204,99 "baixista"; farelo
298,41-322,58 "lateral"; óleo 61,96-70,41 "baixista") não puderam ser
confrontadas com nenhum ponto de dado em toda a sua janela de vigência (06
a 13/08), porque o hiato do pipeline cobriu literalmente os sete dias
inteiros do horizonte de previsão. O forecast de 30 dias (gerado na mesma
data, alvo 2026-09-05) segue formalmente ativo, mas já perdeu, sem
possibilidade de recuperação, os primeiros sete dos seus trinta dias de
janela sem qualquer verificação — quando (e se) o pipeline normalizar, o
forecast de 30 dias deveria ser o primeiro a ser reavaliado, já que sua
banda foi calculada sobre uma base de preço (06/08) que pode estar
significativamente desatualizada frente ao nível real de mercado.

*Nenhum número foi inventado ou estimado além do que consta no briefing
lido em 2026-08-13 e nos insights anteriores referenciados. A contribuição
central desta leitura foi (1) registrar que a ausência de dado novo cruzou
o limiar mais forte desta série até agora — uma semana cheia de pregão
(cinco sessões: 07, 10, 11, 12 e 13/08) perdida por completo, com o
calendário retornando ao mesmo dia da semana (quinta-feira) do último dado
real, sete dias corridos depois; (2) registrar que o forecast estatístico
de 7 dias gerado em 06/08, com alvo formal em 13/08 (hoje), expirou sem
nunca ter sido confrontado com um único fechamento real, o primeiro caso
desta natureza na série; (3) recalcular com precisão todos os contadores de
dias da fila de julgamento e da lente fiscal (D+7 agora a 56 dias, D+90 a
27 dias, PIS/Cofins completando o 9º dia útil sem status, MP 1.358 a 33
dias, WASDE a 34 dias de atraso, monitor tributário a 69 dias, RS sem
segunda leitura há 8 dias, COT a 16 dias, Danantara a 19 dias); e (4) manter
a leitura de tendência de 4 sessões (03→06/08) como o melhor sinal tático
disponível — farelo ganhando força relativa (oil-meal spread -5,4%) e óleo
em quebra técnica (-1,73%, abaixo do suporte 72,00) —, tratando os três
itens da fila de julgamento —
`alerta-quebra_suporte-oleo_cbot-2026-08-06`,
`revisao-2026-06-11_ratio-81-prepara-janela-de-tranches-farelo-D+7` e
`release-nopa-2026-08-06` — no contexto específico de uma semana cheia de
pregão sem sessão nova, sem inventar confirmação, tonelagem ou percentil
que o briefing não trouxe.*
