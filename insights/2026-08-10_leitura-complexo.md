---
data: 2026-08-10
titulo: "Segunda-feira útil chega e o pipeline continua travado em 06/08 — agora são dois pregões reais perdidos (sexta 07/08 e a própria segunda 10/08), não mais só um fim de semana, enquanto a tendência de 4 sessões (03→06/08) segue mostrando farelo ganhando força relativa dentro do crush (oil-meal spread -5,4%) e óleo rompido tecnicamente (-1,73%, abaixo do suporte 72,00)"
tags: [complexo, auto-claude]
fontes:
  - CME CBOT (ZSU26 soja / ZMU26 farelo / ZLU26 óleo) — sessão de 2026-08-06 (quinta-feira), a MESMA sessão já usada nas leituras de 2026-08-07, 2026-08-08 e 2026-08-09; hoje é segunda-feira 2026-08-10, um dia útil normal de pregão, e ainda assim nenhuma sessão nova apareceu — ver Honestidade
  ...
  - BCB PTAX — carimbo mais recente 2026-08-05 (USD/BRL 5,1154); agora 5 dias corridos sem atualização
  - CEPEA/ESALQ Soja Paranaguá via NAG — carimbo mais recente 2026-08-05, R$ 144,91/saca; 5 dias sem atualização
  - CEPEA/ESALQ Soja Paraná interior via NAG — carimbo mais recente 2026-08-05, R$ 136,73/saca
  - NAG Físico BR — carimbo mais recente 2026-08-05 (farelo MT/IMEA R$ 1.675,10/ton, congelado há 10 dias desde 31/07; Rondonópolis/MT R$ 1.700,00/ton, mesmo congelamento; RS R$ 1.800,00/ton, agora 5 dias sem segunda leitura de confirmação); prêmios export PGUA farelo (+0,05 USD/sht) e óleo (+0,08 cts/lb), carimbo 2026-08-05, "mês Agosto/26"
  - CFTC COT Managed Money, Swap Dealers e Producer/Merchant — corte de 2026-07-28, agora 13 dias sem atualização — mais que o dobro do ciclo semanal normal
  - USDA Crop Progress — corte rotulado 2026-08-02, mesmos valores do corte de 2026-07-26 (11% excelente / 52% boa / 7% ruim), sétima leitura seguida sem mudança
  - USDA WASDE — ausente da janela, agora 31 dias de atraso desde o último dado (2026-07-10)
  ...
  - system/tributario_watch.toml (lido como referência, não editado) — `atualizado_em` 2026-06-05, agora 66 dias sem atualização
  ...
  - Cruza com [[2026-08-09_leitura-complexo]], [[2026-08-08_leitura-complexo]], [[2026-08-07_leitura-complexo]] e [[2026-06-11_ratio-81-prepara-janela-de-tranches-farelo]] (tese original do D+7, checkpoint segue vencido)
status: ativa
...
**Hoje é segunda-feira, 2026-08-10 — um dia útil normal de pregão na CBOT — e
o fato mais importante desta leitura, pela quarta vez seguida, é estrutural,
não de mercado: o briefing lido hoje ainda traz o fechamento de
quinta-feira, 2026-08-06, como o dado mais recente de CBOT, PTAX, físico
NAG, COT e RSS.** As três leituras anteriores (07/08, 08/08, 09/08) já
haviam registrado essa ausência, mas todas puderam justificar parte do gap
pelo calendário — sexta-feira era só um dia, e sábado/domingo não têm pregão.
**Hoje esse argumento de calendário para de funcionar por completo: 10/08 é
segunda-feira, dia útil pleno, e mesmo assim não há um único carimbo novo em
nenhuma fonte.** Isso muda a natureza do problema de "um pregão pode ter
ficado de fora por atraso de coleta" para "dois pregões reais e consecutivos
(sexta 07/08 e a própria segunda 10/08) estão ausentes, com um fim de semana
inteiro no meio sem nenhuma atualização registrada nesse intervalo" — o
padrão mais consistente com uma falha de execução do pipeline (o job que
gera `briefing/latest.md` parece não ter rodado desde a noite de
05→06/08) do que com atraso pontual de uma fonte específica. Esta leitura
trata isso como o achado mais acionável do dia, à frente de qualquer
conclusão sobre preço — ver Honestidade para o detalhamento completo e a
recomendação de verificação técnica direta.

Dito isso, os dados que o briefing efetivamente carrega — os 4 pregões
02026-08-03 a 2026-08-06 — continuam contando uma história consistente e já
identificada nas leituras anteriores, e que esta análise aprofunda: o
oil-meal spread (quanto o óleo vale a mais que o farelo dentro da margem de
crush, em USD/bushel) caiu em todas as 4 sessões seguidas (0,628 → 0,594
USD/bu, -5,4% acumulado), um sinal tático de farelo recuperando força
...
100/100 — não mudam há pelo menos 11 dias corridos (desde 30/07 até o
carimbo de 06/08, e sem novo carimbo desde então), porque medem condições de
oferta/demanda de mais longo prazo que não "pausam" quando o pregão não
abre. **Leitura de uma linha:** o pivô do complexo hoje é duplo — de um
lado, a lacuna de dado deixou de ser um detalhe de rodapé para se tornar o
fato dominante da semana (dois pregões reais perdidos, não um); do outro, a
única informação de mercado disponível, quando lida em janela de 4 sessões
em vez de 1 dia, mostra farelo ganhando força tática dentro do crush
enquanto o óleo aprofunda uma quebra técnica estrutural — maior convicção
nos mecanismos estruturais (ISF, ISO, ABIOVE) que independem do calendário,
confiança moderada na tendência tática de 4 sessões (mais pontos de dado que
nas leituras anteriores, mas ainda uma janela curta), e confiança muito
baixa — a mais baixa desta série até agora — sobre o que de fato aconteceu
com o preço entre a tarde de 06/08 e agora.

---

## Soja

**Viés: neutro no curtíssimo prazo (últimos 2 pregões conhecidos,
04→05→06/08, mostram consolidação extrema), mas modestamente baixista na
janela de 4 sessões (03→06/08, -1,39% acumulado) — a mesma leitura híbrida
das análises anteriores, agora com um dia adicional de gap que não permite
nem confirmar nem descartar nenhuma das duas.** Último fechamento
disponível: 1.157,50 cts/bushel (CBOT, ticker ZSU26.CBT, 2026-08-06).

### O que sustenta a tese

**A última sessão registrada (06/08) segue sendo a mais estreita da série,
e é também o único dado que existe para julgar se a compressão técnica se
resolveu ou não — e hoje, segunda-feira, deveria ter havido pelo menos uma
nova sessão para testar isso, e não houve.** Abertura 1.157,25, máxima
...
movimento mais amplo quando aparece o catalisador — e agora há dois
catalisadores represados que não chegaram (o COT da semana, que normalmente
sairia numa sexta, e a própria reabertura de segunda-feira), o que reforça a
hipótese de represamento técnico sem confirmá-la.
...
em 2 semanas corridas) seja pequena para qualificar como tendência forte.
...
ao pregão anterior (54,50 em 05/08). Sem sessão de sexta-feira nem de hoje,
esta leitura não tem como saber se esse formato persistiu — e, relevante
para quem monitora spreads de calendário, dois pregões represados
significam que qualquer ajuste de curva que tenha ocorrido no intervalo
pode aparecer de uma vez, como um salto, na próxima sessão real, em vez de
gradualmente.

**O câmbio permanece com o mesmo carimbo de quarta-feira (05/08), agora há
5 dias sem atualização — mas a série das últimas 2 semanas mostra uma
depreciação leve e consistente do real.** USD/BRL PTAX foi de 5,0666
(24/07) a 5,1154 (05/08, BCB) — alta de +0,96% em 8 pregões, com oscilação
no meio do caminho (chegou a 5,1217 em 29/07, recuou a 5,0723 em 03/08).
A paridade teórica em reais (sem prêmio de basis) está em **R$ 130,54/saca**
(indicators, CBOT 1.157,50 cts × USD/BRL 5,1154, 06/08). **Mecanismo e
leitura:** um real mais fraco eleva a paridade em reais mesmo com a CBOT
parada ou em leve queda — vetor estrutural moderadamente favorável para
quem vende soja fisicamente no Brasil, parcialmente compensando a queda de
-1,39% do CBOT na mesma janela. Qualquer movimento de câmbio de sexta,
sábado, domingo ou hoje não está capturado neste número — e, como o USD/BRL
...
144,91/saca (05/08, carimbo mais recente, agora 5 dias parado).
...
**O posicionamento do COT (CFTC) segue no corte de 28/07/2026, agora 13
...
direção, o que amplificaria qualquer queda. O corte tem agora 13 dias,
quase o dobro do intervalo semanal normal de publicação — o próximo corte
(previsto para sair numa sexta-feira, hipoteticamente já 07/08 ou 14/08) é
o dado mais urgente desta janela para reavaliar se essa concentração ainda
existe.

### O que invalida / risco para a soja

- **A sessão de sexta-feira (07/08) e a de hoje (10/08) aparecerem
...
- **O WASDE finalmente voltar a ser publicado** (31 dias de atraso).

### Leitura operacional — soja

Para quem opera os dois lados, a lacuna de dado hoje é, em si, a informação
operacional mais relevante: dois pregões reais represados (sexta e a própria
segunda) aumentam a probabilidade de um movimento de abertura mais amplo do
que o normal quando o pregão realmente voltar a ser refletido no briefing,
simplesmente porque há mais tempo e mais notícia potencialmente acumulada
(COT, RSS, câmbio) para o mercado digerir de uma vez. A leitura de tendência
de 4 sessões (-1,39%) sugere viés ligeiramente baixista de curtíssimo prazo,
mas com convicção baixa — a magnitude é pequena e o hiato de dados, agora
maior do que em qualquer leitura anterior desta série, pede cautela extra
antes de dimensionar posição nova. A concentração de posição comprada em
...
mais do que o normal dado esse desenho de posicionamento — e, com dois
pregões represados, o primeiro pregão real após o hiato é o candidato mais
provável para esse tipo de movimento amplo. Para quem opera o físico
brasileiro, a recomendação permanece: buscar confirmação direta na praça da
manchete de máxima do ano antes de qualquer decisão de originação, usando o
basis prático do dono, não a manchete, como referência.
...
confirmar ou reverter — a lacuna de hoje é, especificamente para este
sinal, a pior notícia da semana, porque é justamente a próxima sessão que
decidiria se o movimento continua.** Trata
...
### O D+7 chega a 53 dias vencido — e o ratio nunca fechou abaixo de 80% no período recente
...
formal (D+7) caiu em 18/06/2026; hoje, 10/08/2026, são **53 dias corridos**
...
zona. O próximo marco formal é o D+90 (2026-09-09), agora a **30 dias**.
...
novo.** 0,6281 USD/bu (03/08) → 0,6226 (04/08) → 0,6160 (05/08) → 0,5940
(06/08, indicators) — queda acumulada de **-5,43% em 4 sessões seguidas**,
sem uma única reversão no meio do caminho. **Mecanismo:** o oil-meal spread
mede quanto o óleo vale a mais que o farelo dentro da margem de crush, em
USD por bushel; uma queda consistente e multi-sessão significa que o farelo
está, sessão após sessão, recuperando participação relativa dentro do valor
total do crush — o oposto tático do que sustenta a tese estrutural "óleo
manda, farelo sobra". Com 4 pontos de dados na mesma direção, esta leitura
mantém a classificação das análises de 08/08 e 09/08: tendência tática em
desenvolvimento, ainda não confirmada por dado que dependa de uma quinta
sessão real — que hoje, segunda-feira, deveria já existir e não existe.
...
14 dias deste briefing (pelo menos 30/07 a 06/08, ou seja, 11 dias corridos
sem um único carimbo diferente), sem novo carimbo hoje porque não há
sessão nova.** As projeções ABIOVE seguem, sem alteração, mostrando a
exportação de farelo brasileiro caindo de 1.400 mil toneladas em
...
e por isso continuam sendo a parte mais sólida desta leitura de farelo.

**Prêmio de exportação em Paranaguá permanece perto de zero, carimbo de
2026-08-05, agora 5 dias sem atualização.** +0,05 USD/short ton, "mês
...
05/08.** Mato Grosso/IMEA congelado em R$ 1.675,10/ton **há 10 dias** (desde
...
**segue sem uma segunda leitura de confirmação, agora há 5 dias**. Quanto
mais tempo passa sem segunda leitura, maior o peso da ressalva de que pode
ser anomalia de coleta, não um novo nível de preço confirmado — 5 dias sem
...
- **O ratio Far/Soj finalmente fechar abaixo de 80%** após 53 dias sem
...
4 sessões seguidas (oil-meal spread), mas a quinta confirmação — que
deveria ter chegado hoje, segunda-feira — continua ausente, o que
...
sessão chegar, ela carrega potencialmente dois pregões de mercado
...
dado que já são 5 dias sem confirmação via o dado público.
...
sem nenhum dado novo hoje para testar se o movimento continuou, estabilizou
ou reverteu.** Trata `alerta-quebra_suporte-oleo_cbot-2026-08-06` (fato:
...
conhecida, sem confirmação de sessão nova por já 2 pregões reais represados.
...
mantém essa interpretação como hipótese de trabalho, agora há 2 pregões
sem poder testá-la.
...
— mesmo valor em todos os carimbos disponíveis na janela de 14 dias (pelo
menos 30/07 a 06/08, 11 dias corridos sem mudança).** A tese estrutural
(óleo dominando o valor do crush) segue formalmente intacta como último
retrato conhecido, coexistindo sem contradição técnica com o preço em
tendência de baixa e a curva cada vez mais invertida — o ISO mede quem
...
recente, agora 13 dias velha, e olhando as 3 categorias juntas, o óleo é a
...
categoria. Com 13 dias de idade, esse corte é o dado de posicionamento mais
...
acima de 68,55 — mas com uma ressalva nova nesta leitura: com dois pregões
reais represados (sexta 07/08 e a própria segunda 10/08), a primeira sessão
real após o hiato carrega risco elevado de gap de abertura em qualquer
direção, o que muda a mecânica prática de onde e como esse stop deveria
estar posicionado (um stop lógico numa cotação intradiária pode não
capturar um gap que abre diretamente acima ou abaixo do nível). A leitura
de que o aprofundamento da backwardation vinha do fim da curva, não do
início, continua relevante para quem opera spreads de calendário —
estruturas que vendem os vencimentos mais distantes contra os próximos
(vende F27/H27, compra Q26/U26) seguem coerentes com o último dado
disponível, mas carregam agora quatro dias corridos de risco de gap (sexta
que faltou + fim de semana + hoje) sem atualização de preço para
...
agora 53 dias vencida.** A recomendação operacional permanece: exigir
...
ainda ausente, essa confirmação segue impossível de obter.
...
corridos (desde 30/07), e ambos continuam sendo a parte mais sólida desta
...
leitura. Com dois pregões reais represados, essa tensão fica sem teste
novo: a próxima sessão real, sempre que o pipeline voltar a rodar, decide
se o sinal tático do farelo se firma ou se dissolve.
...
`vigencia_ate` 2026-07-31) — hoje, 2026-08-10 (segunda-feira), completa o
6º dia útil desde o vencimento** (dias úteis decorridos: 03, 04, 05, 06 e
07/08, mais o próprio dia de hoje). Nenhum item do RSS desde 06/08 trouxe
informação sobre este tema, e o monitor tributário
(`system/tributario_watch.toml`) segue parado desde 2026-06-05 — **66 dias
...
última leitura disponível. Com quase uma semana e meia de pregões (03 a
07/08, mais hoje 10/08) transcorrida sem confirmação, este item passa a
ser, nesta leitura, a verificação manual mais urgente do conjunto fiscal —
mais até do que nas leituras anteriores, dado o tempo decorrido.

**MP 1.358/2026 — subvenção à gasolina (R$ 0,89/L) e diesel (R$ 0,35/L) —
vigência formal venceu há 30 dias** (`vigencia_ate` 11/07/2026), sem
...
plena prevista para 01/09/2026, agora a **22 dias**); INDONESIA-B50
...
**O monitor tributário como um todo está há 66 dias sem qualquer
atualização** — prioridade de manutenção do sistema, especialmente relevante
agora que a isenção PIS/Cofins acumula 6 dias úteis sem confirmação de
status.
...
do mercado.** Dois pregões reais (sexta 07/08 e a própria segunda 10/08)
estão ausentes do briefing, e o job que gera `briefing/latest.md` parece
não ter rodado desde 05→06/08 — recomendação de verificação técnica direta
antes de tratar qualquer gap de preço na próxima abertura refletida como
movimento de mercado genuíno, e não como acúmulo de vários dias de notícia
processados de uma vez.

**O COT (CFTC) referente a 04/08/2026 segue ausente, agora 13 dias desde o
último corte (28/07) — mais que o dobro do intervalo semanal normal —, e o
corte seguinte (nominalmente de 11/08) também já estaria próximo do prazo
normal de publicação.** Quando o dado chegar, o ponto mais relevante a
checar é se o managed money e os swap dealers em óleo (que, no último
corte, tinham comportamento divergente — managed money já reduzindo, swap
dealers ainda "gordos") convergiram na mesma direção.
...
tese do D+7 (agora 53 dias vencida), ou se rompe para baixo, confirmando-a
com atraso.
...
**A isenção PIS/Cofins do biodiesel completa hoje o 6º dia útil sem
...
leitura de confirmação, agora há 5 dias** — recomendação de contato direto
com a praça.

**O USDA Crop Progress rotulado 2026-08-02 segue com os MESMOS valores do
corte de 26/07**, agora pela sétima leitura seguida; o próximo corte,
referente à semana de 09/08, deveria sair hoje ou amanhã.
...
**O WASDE segue fora da janela deste briefing, agora 31 dias de atraso**
desde o último dado (10/07/2026).

**Danantara (Indonésia) assume plenamente a cadeia de exportação de palma
em 01/09/2026, a 22 dias de hoje** — monitorar se a curva do óleo CBOT
...
recente é de 2026-08-06 (lido em 2026-08-10), e os pontos onde a confiança
é baixa:

**1. O achado central desta leitura, agora pela quarta vez seguida e com
uma mudança de natureza importante: nenhuma fonte do briefing trouxe dado
novo desde a sessão de 2026-08-06 — nem CBOT, nem PTAX, nem NAG físico, nem
COT, nem RSS, nem INMET, nem ENSO, nem MPOB, nem BCBA.** Nas três leituras
anteriores (07/08, 08/08, 09/08), parte do gap ainda podia ser atribuída ao
calendário (sexta-feira era um único dia útil perdido; sábado e domingo não
têm pregão). **Hoje esse argumento deixa de se sustentar: 2026-08-10 é
segunda-feira, um dia útil pleno de pregão na CBOT, e mesmo assim o
briefing não trouxe nenhum carimbo posterior a 06/08.** Isso eleva a
contagem real de pregões perdidos de "1 (sexta-feira)" para "2 (sexta-feira
e a própria segunda-feira de hoje)", com um fim de semana inteiro no meio
sem qualquer atualização registrada. O padrão — ausência total e uniforme
em todas as fontes, não apenas na CBOT — é mais consistente com o job que
gera `briefing/latest.md` não tendo rodado desde a noite de 05→06/08 do
que com atraso pontual de uma fonte isolada. Esta leitura recomenda, pela
quarta vez e agora com prioridade mais alta, verificação técnica direta do
pipeline de coleta (`main.py` / scraper CME / agendador do job) antes de
mais um ciclo de leitura ser gerado sobre o mesmo dado de 06/08.
...
classificação não pôde avançar desde a leitura de 09/08.
...
recente, agora 13 dias sem atualização — o intervalo mais longo desta
série de leituras.** A leitura de swap dealers "gordos" em óleo e da
concentração comprada em soja (managed money + swap dealers) usa dado de
quase 2 semanas de idade — pode já estar desatualizada, especialmente se um
catalisador de mercado tiver ocorrido nos dois pregões represados.

**5. O prêmio de exportação de Paranaguá (soja) e o CEPEA Paraná interior
não trouxeram carimbo novo desde 2026-08-05** — agora 5 dias sem
atualização.
...
incluindo qualquer variação de sexta-feira ou de hoje.
...
**10. O ratio Far/Soj (80,60%) segue sem fechar abaixo de 80%, agora 53
...
D+90 (2026-09-09, a 30 dias) como próximo marco formal.

**11. O USDA Crop Progress rotulado 2026-08-02 trouxe, pelo sétimo dump
...
(semana de 09/08, publicação nominalmente em torno de hoje ou amanhã).

**12. A isenção PIS/Cofins do biodiesel — sem confirmação de renovação ou
caducidade neste briefing, completando hoje o 6º dia útil sem status.** O
monitor tributário está 66 dias sem atualização; esta leitura não presume
nenhum dos dois cenários.

**13. O WASDE permanece completamente fora da janela deste briefing** —
agora 31 dias de atraso desde o último dado (10/07/2026).
...
tem alvo em 2026-08-13 — hoje, 10/08, já se passaram 4 dos 7 dias daquela
...
lido em 2026-08-10 e nos insights anteriores referenciados. A contribuição
central desta leitura foi (1) registrar que a ausência de dado novo deixou
de ser explicável por calendário — hoje é segunda-feira, dia útil pleno, e
o gap já soma dois pregões reais represados (sexta 07/08 e a própria
segunda 10/08), não mais um único dia; (2) recalcular com precisão todos os
contadores de dias da fila de julgamento e da lente fiscal (D+7 agora a 53
dias, D+90 a 30 dias, PIS/Cofins completando o 6º dia útil sem status, MP
1.358 a 30 dias, WASDE a 31 dias de atraso, monitor tributário a 66 dias,
RS sem segunda leitura há 5 dias, COT a 13 dias, Danantara a 22 dias); e (3)
manter a leitura de tendência de 4 sessões (03→06/08) como o melhor sinal
tático disponível — farelo ganhando força relativa (oil-meal spread -5,4%)
e óleo em quebra técnica (-1,73%, abaixo do suporte 72,00) — tratando os
três itens da fila de julgamento —
`alerta-quebra_suporte-oleo_cbot-2026-08-06`,
`revisao-2026-06-11_ratio-81-prepara-janela-de-tranches-farelo-D+7` e
`release-nopa-2026-08-06` — no contexto específico de uma segunda-feira sem
sessão nova, sem inventar confirmação, tonelagem ou percentil que o
briefing não trouxe.*
