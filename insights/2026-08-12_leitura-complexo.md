---
data: 2026-08-12
titulo: "Quarta-feira 12/08 fecha a primeira semana útil inteira sem um único pregão real novo (sexta 07, segunda 10, terça 11, quarta 12), enquanto os mesmos 4 pregões genuinamente conhecidos (03→06/08) seguem mostrando farelo ganhando força relativa dentro do crush (oil-meal spread -5,4% acumulado) e óleo travado abaixo do suporte técnico rompido (67,60 vs 72,00)"
tags: [complexo, auto-claude]
fontes:
  - CME CBOT (ZSU26 soja / ZMU26 farelo / ZLU26 óleo) — sessão de 2026-08-06 (quinta-feira), a MESMA sessão já usada nas leituras de 2026-08-07, 08-08, 08-09, 08-10 e 08-11; hoje é quarta-feira 2026-08-12, terceiro dia útil pleno seguido sem nenhum carimbo novo — ver Honestidade
  ...
  - BCB PTAX — carimbo mais recente 2026-08-05 (USD/BRL 5,1154); agora 7 dias corridos sem atualização
  - CEPEA/ESALQ Soja Paranaguá via NAG — carimbo mais recente 2026-08-05, R$ 144,91/saca; 7 dias sem atualização
  - CEPEA/ESALQ Soja Paraná interior via NAG — carimbo mais recente 2026-08-05, R$ 136,73/saca
  - NAG Físico BR — carimbo mais recente 2026-08-05 (farelo MT/IMEA R$ 1.675,10/ton, congelado há 12 dias desde 31/07; Rondonópolis/MT R$ 1.700,00/ton, mesmo congelamento; RS R$ 1.800,00/ton, agora 7 dias sem segunda leitura de confirmação); prêmios export PGUA farelo (+0,05 USD/sht) e óleo (+0,08 cts/lb), carimbo 2026-08-05, "mês Agosto/26"
  - CFTC COT Managed Money, Swap Dealers e Producer/Merchant — corte de 2026-07-28, agora 15 dias sem atualização — mais que o dobro do ciclo semanal normal
  - USDA Crop Progress — corte rotulado 2026-08-02, mesmos valores do corte de 2026-07-26 (11% excelente / 52% boa / 7% ruim), nona leitura seguida sem mudança
  - USDA WASDE — ausente da janela, agora 33 dias de atraso desde o último dado (2026-07-10)
  ...
  - system/tributario_watch.toml (lido como referência, não editado) — `atualizado_em` 2026-06-05, agora 68 dias sem atualização
  ...
  - Cruza com [[2026-08-11_leitura-complexo]], [[2026-08-10_leitura-complexo]], [[2026-08-09_leitura-complexo]], [[2026-08-08_leitura-complexo]], [[2026-08-07_leitura-complexo]] e [[2026-06-11_ratio-81-prepara-janela-de-tranches-farelo]] (tese original do D+7, checkpoint segue vencido)
status: ativa
...
**Hoje é quarta-feira, 2026-08-12 — o terceiro dia útil pleno seguido de
pregão normal na CBOT — e o fato mais importante desta leitura, pela sexta
...
recente de CBOT, PTAX, físico NAG, COT e RSS.** As cinco leituras anteriores
(07/08, 08/08, 09/08, 10/08 e 11/08) já haviam registrado essa ausência
crescente, e a de ontem (11/08) já havia notado que o hiato tinha crescido
de dois para três pregões reais perdidos. **Hoje esse hiato fecha, pela
primeira vez, uma semana útil inteira sem nenhum dado novo: sexta 07/08,
segunda 10/08, terça 11/08 e a própria quarta 12/08 de hoje somam QUATRO
pregões reais consecutivos ausentes, com o fim de semana inteiro no meio
também sem qualquer atualização registrada.** Isso muda a natureza do
diagnóstico outra vez: "um ou dois pregões perdidos" ainda podia, em tese,
refletir um problema pontual de coleta que se resolveria sozinho; "três
pregões perdidos com o segundo dia útil seguido sem carimbo", como registrado
ontem, já apontava para falha persistente do job. Hoje, com o TERCEIRO dia
útil consecutivo (segunda, terça e agora quarta) também sem carimbo novo — e
uma semana de calendário inteira (07 a 12/08, contando o fim de semana) sem
um único ponto de dado —, o padrão deixa de ser compatível com qualquer
explicação de atraso pontual e aponta, com a convicção mais alta desta série
inteira, para uma falha de execução persistente do job que gera
`briefing/latest.md` — que parece não ter rodado desde a noite de 05→06/08,
ou seja, há agora 6 dias corridos. Esta leitura mantém o tratamento desse
...
verificação técnica direta, agora com prioridade máxima absoluta dado que o
hiato já superou uma semana útil cheia.
...
identificada nas cinco leituras anteriores, e que esta análise aprofunda mais
...
100/100 — não mudam há pelo menos 12 dias corridos (desde 31/07 até o carimbo
de 06/08, e sem novo carimbo desde então), porque medem condições de
oferta/demanda de mais longo prazo que não "pausam" quando o pregão não abre.
**Leitura de uma linha:** o pivô do complexo hoje segue sendo duplo — de um
lado, a lacuna de dado deixou de ser sequer um "evento dominante da semana" e
virou uma semana útil inteira sem informação nova, o maior hiato desta série
inteira; do outro, a única informação de mercado disponível, lida em janela
de 4 sessões em vez de 1 dia, continua mostrando farelo ganhando força tática
dentro do crush enquanto o óleo aprofunda uma quebra técnica estrutural —
maior convicção nos mecanismos estruturais (ISF, ISO, ABIOVE) que independem
do calendário, confiança moderada na tendência tática de 4 sessões (o mesmo
conjunto de pontos de dado das últimas cinco leituras, sem nenhum ponto novo
para reforçá-la ou refutá-la), e confiança muito baixa — agora a mais baixa
desta série inteira, superando a de ontem — sobre o que efetivamente
aconteceu com o preço entre a tarde de 06/08 e agora, um hiato que já soma 6
dias corridos e 4 sessões reais de mercado.
...
sessões (03→06/08, -1,39% acumulado) — a mesma leitura híbrida das cinco
...
resolveu — e hoje, quarta-feira, já deveriam ter existido pelo menos TRÊS
novas sessões (segunda, terça e quarta) para testar isso, e não existe
...
o catalisador — e agora há QUATRO catalisadores represados que não chegaram
(o COT da semana passada, que normalmente sairia numa sexta; o COT desta
semana, que já deveria ter saído hoje ou amanhã; a reabertura de
segunda-feira; e as sessões de terça e quarta), o que reforça ainda mais a
hipótese de represamento técnico sem, no entanto, confirmá-la — a confirmação
só existe quando o pregão real voltar a aparecer no briefing.
...
anterior (54,50 em 05/08). Sem sessão de sexta, segunda, terça ou hoje, esta
leitura não tem como saber se esse formato persistiu — e, relevante para
quem monitora spreads de calendário, quatro pregões represados significam
que qualquer ajuste de curva que tenha ocorrido no intervalo pode aparecer de
uma vez, como um salto maior do que o normal, na próxima sessão real, em vez
de gradualmente distribuído ao longo de quatro dias.

**O câmbio permanece com o mesmo carimbo de quarta-feira (05/08), agora há 7
...
câmbio de sexta, sábado, domingo, segunda, terça ou hoje não está capturado
neste número — e, como o USD/BRL é o canal mais direto entre o CBOT em
dólares e o preço físico em reais, essa é, junto com o próprio CBOT, a lacuna
mais relevante para quem decide originação ou hedge cambial hoje.
...
(05/08, carimbo mais recente, agora 7 dias parado). **Mecanismo:**
...
**O posicionamento do COT (CFTC) segue no corte de 28/07/2026, agora 15
...
qualquer queda. O corte tem agora 15 dias — mais de dois ciclos semanais
completos sem renovação. Já deveriam ter saído, no mínimo, dois cortes novos
(nominalmente 07/08 e 14/08 está próximo); o dado mais urgente desta janela
para reavaliar se essa concentração ainda existe.

### O que invalida / risco para a soja

- **As sessões represadas (07, 10, 11 e 12/08) aparecerem retroativamente
...
- **O WASDE finalmente voltar a ser publicado** (33 dias de atraso).

### Leitura operacional — soja

Para quem opera os dois lados, a lacuna de dado hoje é, mais uma vez, a
informação operacional mais relevante: quatro pregões reais represados
(sexta, segunda, terça e a própria quarta de hoje) — uma semana útil cheia —
aumentam ainda mais a probabilidade de um movimento de abertura amplo quando
o pregão realmente voltar a ser refletido no briefing — mais tempo, mais
notícia potencialmente acumulada (COT, RSS, câmbio) para o mercado digerir
de uma só vez, e agora com uma janela maior que qualquer uma desta série. A
leitura de tendência de 4 sessões (-1,39%) sugere viés ligeiramente baixista
de curtíssimo prazo, mas com convicção baixa — a magnitude é pequena e o
hiato de dados, agora o maior desta série, pede cautela extra antes de
dimensionar posição nova. A concentração de posição comprada em managed
money + swap dealers é um argumento de contexto para quem avalia o lado
short: um catalisador baixista genuíno (WASDE, COT confirmando redução de
posição, ou ruptura técnica abaixo de 1.155,75) tem potencial de acelerar
mais do que o normal dado esse desenho de posicionamento — e, com quatro
...
confirmar ou reverter — e a lacuna de hoje agora soma três dias úteis
...
### O D+7 chega a 55 dias vencido — e o ratio nunca fechou abaixo de 80% no período recente
...
formal (D+7) caiu em 18/06/2026; hoje, 12/08/2026, são **55 dias corridos**
...
zona. O próximo marco formal é o D+90 (2026-09-09), agora a **28 dias**.
...
agora represado por três dias úteis inteiros.** 0,6281 USD/bu (03/08) →
...
análises de 08/08 a 11/08: tendência tática em desenvolvimento, ainda não
confirmada por dado que dependa de uma quinta sessão real — que já deveria
ter existido três vezes (segunda, terça e hoje) e ainda não existe.
...
deste briefing (pelo menos 31/07 a 06/08, ou seja, 12 dias corridos sem um
...
2026-08-05, agora 7 dias sem atualização.** +0,05 USD/short ton, "mês
...
05/08.** Mato Grosso/IMEA congelado em R$ 1.675,10/ton **há 12 dias** (desde
...
**segue sem uma segunda leitura de confirmação, agora há 7 dias**. Quanto
mais tempo passa sem segunda leitura, maior o peso da ressalva de que pode
ser anomalia de coleta, não um novo nível de preço confirmado — 7 dias sem
...
- **O ratio Far/Soj finalmente fechar abaixo de 80%** após 55 dias sem
...
deveria ter chegado três vezes, segunda, terça e hoje — continua ausente, o
que efetivamente congela a decisão por mais um dia útil inteiro. A
recomendação operacional segue a mesma das leituras anteriores, com peso
adicional dado o tamanho crescente do hiato: aguardar a próxima sessão real
antes de ajustar tamanho de posição no spread Far/Soj, e considerar que,
quando essa sessão chegar, ela carrega potencialmente quatro pregões de
mercado represado, o que pode produzir um movimento de abertura maior do
que o normal em qualquer direção. Para quem opera o físico de farelo no RS,
a recomendação permanece: não tratar R$ 1.800,00/ton como preço de mercado
confirmado sem uma segunda leitura, e considerar contato direto com a praça
dado que já são 7 dias sem confirmação via o dado público.
...
sem nenhum dado novo hoje, pelo terceiro dia útil seguido, para testar se o
...
de sessão nova por já quatro pregões reais represados.
...
mantém essa interpretação como hipótese de trabalho, agora há quatro
...
(pelo menos 31/07 a 06/08, 12 dias corridos sem mudança).** A tese
...
recente, agora 15 dias velha, e olhando as 3 categorias juntas, o óleo é a
...
categoria. Com 15 dias de idade, esse corte é o dado de posicionamento mais
...
quatro pregões reais represados (sexta 07/08, segunda 10/08, terça 11/08 e
a própria quarta 12/08), a primeira sessão real após o hiato carrega risco
...
coerentes com o último dado disponível, mas carregam agora seis dias
corridos de risco de gap (sexta que faltou + fim de semana + segunda + terça
+ hoje) sem atualização de preço para reavaliar. Para quem considera nova
posição comprada, a posição residual dos swap dealers (net long ~88.407
contratos, sem sinal de redução no último corte) é argumento de cautela
adicional: ainda há posição especulativa "gorda" que pode ser liquidada se
a queda técnica continuar, o que favorece mais o lado vendido no curto
prazo do que uma aposta contrária.
...
agora 55 dias vencida.** A recomendação operacional permanece: exigir
...
ausente pelo terceiro dia útil seguido, essa confirmação segue impossível
de obter.
...
**ISF em 80/100, ISO em 100/100 — ambos inalterados por pelo menos 12 dias
...
é a tensão mais relevante do complexo nesta leitura. Com quatro pregões
reais represados — a primeira semana útil inteira sem dado novo desta série
— essa tensão fica sem teste novo por mais um dia: a próxima sessão real,
sempre que o pipeline voltar a rodar, decide se o sinal tático do farelo se
firma ou se dissolve.
...
`vigencia_ate` 2026-07-31) — hoje, 2026-08-12 (quarta-feira), completa o
8º dia útil desde o vencimento** (dias úteis decorridos: 03, 04, 05, 06, 07,
10 e 11, mais o próprio dia de hoje). Nenhum item do RSS desde 06/08 trouxe
informação sobre este tema, e o monitor tributário
(`system/tributario_watch.toml`) segue parado desde 2026-06-05 — **68 dias
...
mais 10, 11 e hoje 12/08) transcorridas sem confirmação, este item
...
vigência formal venceu há 32 dias** (`vigencia_ate` 11/07/2026), sem
...
plena prevista para 01/09/2026, agora a **20 dias**); INDONESIA-B50
...
**O monitor tributário como um todo está há 68 dias sem qualquer
atualização** — prioridade de manutenção do sistema, especialmente relevante
agora que a isenção PIS/Cofins acumula 8 dias úteis sem confirmação de
status.
...
marca de uma semana útil inteira sem dado.** Quatro pregões reais (sexta
07/08, segunda 10/08, terça 11/08 e a própria quarta 12/08) estão ausentes
do briefing, e o job que gera `briefing/latest.md` parece não ter rodado
desde 05→06/08, agora 6 dias corridos — recomendação de verificação técnica
direta, com prioridade máxima absoluta, antes de tratar qualquer gap de
preço na próxima abertura refletida como movimento de mercado genuíno, e
não como acúmulo de vários dias de notícia processados de uma vez.

**O COT (CFTC) referente a 04/08/2026 segue ausente, agora 15 dias desde o
...
corte de 18/08 se aproximando.** Quando o dado chegar, o ponto mais
...
tese do D+7 (agora 55 dias vencida), ou se rompe para baixo, confirmando-a
com atraso.
...
**A isenção PIS/Cofins do biodiesel completa hoje o 8º dia útil sem
...
leitura de confirmação, agora há 7 dias** — recomendação de contato direto
com a praça.

**O USDA Crop Progress rotulado 2026-08-02 segue com os MESMOS valores do
corte de 26/07**, agora pela nona leitura seguida; o próximo corte,
...
**O WASDE segue fora da janela deste briefing, agora 33 dias de atraso**
desde o último dado (10/07/2026).

**Danantara (Indonésia) assume plenamente a cadeia de exportação de palma
em 01/09/2026, a 20 dias de hoje** — monitorar se a curva do óleo CBOT
...
**O forecast estatístico interno de 7 dias (gerado em 2026-08-06, alvo
2026-08-13) vence amanhã, e há 6 dos 7 dias daquela janela já transcorridos
sem um único ponto de dado novo para testá-lo** — se o hiato não se resolver
até amanhã, essa banda específica (soja "baixista" 1.098,32-1.204,99;
farelo "lateral" 298,41-322,58; óleo "baixista" 61,96-70,41) expira sem
nunca ter sido confrontada com um fechamento real.
...
recente é de 2026-08-06 (lido em 2026-08-12), e os pontos onde a confiança
é baixa:

**1. O achado central desta leitura, agora pela sexta vez seguida e com uma
nova mudança de natureza: nenhuma fonte do briefing trouxe dado novo desde
a sessão de 2026-08-06 — nem CBOT, nem PTAX, nem NAG físico, nem COT, nem
RSS, nem INMET, nem ENSO, nem MPOB, nem BCBA.** Na leitura de ontem (11/08),
o hiato já somava três pregões reais perdidos. **Hoje, quarta-feira 12/08,
o hiato fecha, pela primeira vez nesta série, uma semana útil inteira sem
nenhum dado novo: sexta 07/08, segunda 10/08, terça 11/08 e a própria
quarta 12/08 de hoje — quatro pregões reais consecutivos, com o fim de
semana inteiro no meio também sem qualquer atualização registrada.** O
padrão — ausência total e uniforme em todas as fontes, não apenas na CBOT,
e agora persistente por três dias úteis consecutivos (segunda, terça e
quarta) — é incompatível com qualquer hipótese de atraso pontual de uma
...
Esta leitura recomenda, pela sexta vez e agora com a prioridade mais alta
...
classificação não pôde avançar desde a leitura de 11/08.
...
recente, agora 15 dias sem atualização — mais que o dobro do intervalo
...
tiver ocorrido nos quatro pregões represados.

**5. O prêmio de exportação de Paranaguá (soja) e o CEPEA Paraná interior
não trouxeram carimbo novo desde 2026-08-05** — agora 7 dias sem
atualização.
...
incluindo qualquer variação de sexta, segunda, terça ou de hoje.
...
**10. O ratio Far/Soj (80,60%) segue sem fechar abaixo de 80%, agora 55
...
D+90 (2026-09-09, a 28 dias) como próximo marco formal.

**11. O USDA Crop Progress rotulado 2026-08-02 trouxe, pelo nono dump
...
caducidade neste briefing, completando hoje o 8º dia útil sem status.** O
monitor tributário está 68 dias sem atualização; esta leitura não presume
nenhum dos dois cenários.

**13. O WASDE permanece completamente fora da janela deste briefing** —
agora 33 dias de atraso desde o último dado (10/07/2026).
...
tem alvo em 2026-08-13 — amanhã. Hoje, 12/08, já se passaram 6 dos 7 dias
daquela janela sem um único ponto de dado novo para testar a banda, o que
reduz ao mínimo a utilidade prática desse forecast específico até o
pipeline normalizar; resta apenas 1 dia corrido até o alvo, e se o hiato
não se resolver antes disso, a banda de 7 dias expira amanhã sem nunca ter
sido testada contra dado real — o primeiro forecast desta série a vencer
completamente "no escuro".

*Nenhum número foi inventado ou estimado além do que consta no briefing
lido em 2026-08-12 e nos insights anteriores referenciados. A contribuição
central desta leitura foi (1) registrar que a ausência de dado novo cruzou
um novo limiar qualitativo — hoje é o terceiro dia útil consecutivo sem
sessão nova, o que fecha a primeira semana útil inteira (07 a 12/08) sem um
único pregão real, elevando o hiato de três para quatro sessões represadas
e descartando de forma definitiva qualquer explicação de calendário; (2)
recalcular com precisão todos os contadores de dias da fila de julgamento e
da lente fiscal (D+7 agora a 55 dias, D+90 a 28 dias, PIS/Cofins completando
o 8º dia útil sem status, MP 1.358 a 32 dias, WASDE a 33 dias de atraso,
monitor tributário a 68 dias, RS sem segunda leitura há 7 dias, COT a 15
dias, Danantara a 20 dias, forecast 7d vencendo amanhã sem nunca ter sido
testado); e (3) manter a leitura de tendência de 4 sessões (03→06/08) como
o melhor sinal tático disponível — farelo ganhando força relativa (oil-meal
...
`release-nopa-2026-08-06` — no contexto específico de uma semana útil
inteira sem sessão nova, sem inventar confirmação, tonelagem ou percentil
