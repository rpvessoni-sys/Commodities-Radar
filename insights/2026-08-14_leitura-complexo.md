---
data: 2026-08-14
titulo: "Sexta-feira 14/08 abre a SEGUNDA semana sem nenhum dado novo — o hiato do pipeline soma 6 sessões reais represadas (07→14/08) e agora QUATRO forecasts estatísticos de 7 dias seguidos (alvos 10, 11, 12 e 13/08) venceram sem nunca terem sido testados — enquanto os únicos 4 pregões genuinamente conhecidos (03→06/08) seguem mostrando o farelo ganhando força relativa no crush (oil-meal spread -5,4% acumulado) e o óleo travado sob a quebra técnica (67,60 vs suporte 72,00)"
tags: [complexo, auto-claude]
fontes:
  - CME CBOT (ZSU26 soja / ZMU26 farelo / ZLU26 óleo) — sessão de 2026-08-06 (quinta-feira), a MESMA sessão já usada em todas as leituras de 2026-08-07 a 2026-08-13; hoje é sexta-feira 2026-08-14, sexto dia útil seguido (2º, 3º, 4º, 5º, 6º e 7º dias úteis desde o hiato, respectivamente 10, 11, 12, 13 e 14/08 mais a sexta 07/08 original) sem nenhum carimbo novo — ver Honestidade
  ...
  - BCB PTAX — carimbo mais recente 2026-08-05 (USD/BRL 5,1154); agora 9 dias corridos sem atualização
  - CEPEA/ESALQ Soja Paranaguá via NAG — carimbo mais recente 2026-08-05, R$ 144,91/saca; 9 dias sem atualização
  - CEPEA/ESALQ Soja Paraná interior via NAG — carimbo mais recente 2026-08-05, R$ 136,73/saca
  - NAG Físico BR — carimbo mais recente 2026-08-05 (farelo MT/IMEA R$ 1.675,10/ton, congelado desde 31/07; Rondonópolis/MT R$ 1.700,00/ton, mesmo congelamento; RS R$ 1.800,00/ton, agora 9 dias sem segunda leitura de confirmação); prêmios export PGUA farelo (+0,05 USD/sht) e óleo (+0,08 cts/lb), carimbo 2026-08-05, "mês Agosto/26"
  - CFTC COT Managed Money, Swap Dealers e Producer/Merchant — corte de 2026-07-28, agora 17 dias sem atualização
  - USDA Crop Progress — corte rotulado 2026-08-02, mesmos valores do corte de 2026-07-26 (11% excelente / 52% boa / 7% ruim)
  - USDA WASDE — ausente da janela, agora 35 dias de atraso desde o último dado (2026-07-10)
  ...
  - Forecasts estatísticos internos (bandas 7d/30d, MA20+volatilidade+slope) — geração mais recente 2026-08-06; a banda de 7 dias gerada em 06/08 tinha alvo em 13/08 e venceu ONTEM sem nunca ter sido testada, e as bandas de 7 dias geradas em 03, 04 e 05/08 (alvos 10, 11 e 12/08) já haviam vencido igualmente sem teste — ver Visão geral e Honestidade
  - system/tributario_watch.toml (lido como referência, não editado) — `atualizado_em` 2026-06-05, agora 70 dias sem atualização
  ...
  - Cruza com [[2026-08-13_leitura-complexo]], [[2026-08-12_leitura-complexo]], [[2026-08-11_leitura-complexo]], [[2026-08-10_leitura-complexo]] e [[2026-06-11_ratio-81-prepara-janela-de-tranches-farelo]] (tese original do D+7, checkpoint segue vencido)
status: ativa
...
**Hoje é sexta-feira, 2026-08-14, e o fato mais importante desta leitura,
pela oitava vez consecutiva, continua sendo estrutural, não de mercado — mas
hoje ele cruza para um território qualitativamente novo: o hiato deixa de
ser "uma semana cheia perdida" (o marco registrado ontem) e passa a ser
"a SEGUNDA semana de pregão inteira começando sem dado".** O briefing lido
hoje ainda traz o fechamento de quinta-feira, 2026-08-06, como o dado mais
recente de CBOT, PTAX, físico NAG, COT e RSS — **8 dias corridos** e **6
sessões reais represadas** (sexta 07/08, segunda 10/08, terça 11/08, quarta
12/08, quinta 13/08 e a própria sexta 14/08 de hoje). A leitura de ontem
(13/08) já havia fechado o primeiro ciclo semanal completo (quinta a
quinta, 5 sessões perdidas); hoje, sexta-feira, marca o encerramento da
primeira semana de calendário inteira (segunda a sexta) sem um único
pregão refletido no sistema, e a abertura, na prática, de uma segunda
semana no mesmo estado. Um segundo marco reforça a gravidade: o forecast
estatístico de 7 dias gerado em 2026-08-06 com alvo em 2026-08-13 venceu
**ontem**, sem nunca ter sido testado — e, olhando a série completa de
forecasts de 7 dias gerados nos últimos dias antes do hiato (03, 04, 05 e
06/08, com alvos respectivamente em 10, 11, 12 e 13/08), **as QUATRO
bandas de curtíssimo prazo já venceram, uma atrás da outra, sem que
nenhuma delas fosse confrontada com um único fechamento real** — não é
mais um caso isolado, é uma sequência inteira de previsões formais do
sistema expirando "no escuro". Esta leitura mantém o tratamento desse
achado estrutural como o mais acionável do dia, à frente de qualquer
conclusão sobre preço — ver Honestidade para o detalhamento completo e a
recomendação de verificação técnica direta, agora com a maior urgência de
toda a série, dado que o hiato entra na segunda semana e quatro previsões
formais consecutivas já expiraram sem teste.
...
identificada nas sete leituras anteriores, e que esta análise aprofunda mais
...
de um lado, a lacuna de dado abriu uma segunda semana inteira sem pregão e
quatro forecasts formais de 7 dias expiraram em sequência sem jamais terem
sido testados, o marco estrutural mais forte desta série inteira; do outro,
a única informação de mercado disponível, lida em janela de 4 sessões em
vez de 1 dia, continua mostrando farelo ganhando força tática dentro do
crush enquanto o óleo aprofunda uma quebra técnica estrutural — maior
convicção nos mecanismos estruturais (ISF, ISO, ABIOVE) que independem do
calendário, confiança moderada na tendência tática de 4 sessões (o mesmo
conjunto de pontos de dado das últimas sete leituras, sem nenhum ponto novo
para reforçá-la ou refutá-la), e confiança mínima — a mais baixa desta
série inteira, superando a de ontem — sobre o que efetivamente aconteceu
com o preço entre a tarde de 06/08 e agora, um hiato que já soma 8 dias
corridos e 6 sessões reais de mercado.
...
sessões (03→06/08, -1,39% acumulado) — a mesma leitura híbrida das sete
...
resolveu — e hoje, sexta-feira, já deveriam ter existido pelo menos SEIS
novas sessões (sexta 07, segunda 10, terça 11, quarta 12, quinta 13 e a
própria sexta de hoje) para testar isso, e não existe nenhuma.** Abertura
...
e agora há seis sessões represadas mais dois cortes de COT que já deveriam
ter saído (semanas de 04/08 e 11/08), o que reforça ainda mais a hipótese
de represamento técnico sem, no entanto, confirmá-la — a confirmação só
existe quando o pregão real voltar a aparecer no briefing.
...
Com uma segunda semana de silêncio se abrindo agora, essa magnitude
relativamente pequena carrega um risco extra que só cresce: se o mercado
tiver, de fato, continuado a ceder nos seis pregões represados na mesma
...
tamanho do hiato já importa para o dimensionamento de risco, e por que essa
distância hipotética cresce a cada dia útil sem confirmação.
...
anterior (54,50 em 05/08). Sem sessão de sexta, segunda, terça, quarta,
quinta ou hoje, esta leitura não tem como saber se esse formato persistiu —
e, relevante para quem monitora spreads de calendário, seis pregões
represados significam que qualquer ajuste de curva que tenha ocorrido no
intervalo pode aparecer de uma vez, como um salto maior do que o normal, na
próxima sessão real, em vez de gradualmente distribuído ao longo de duas
semanas.

**O câmbio permanece com o mesmo carimbo de quarta-feira (05/08), agora há 9
...
câmbio dos últimos seis pregões represados não está capturado neste número
...
(05/08, carimbo mais recente, agora 9 dias parado). **Mecanismo:**
...
**O posicionamento do COT (CFTC) segue no corte de 28/07/2026, agora 17
...
qualquer queda. O corte tem agora 17 dias — mais de dois ciclos semanais
completos sem renovação. Já deveriam ter saído, no mínimo, dois cortes novos
(nominalmente 07/08 e 14/08, este último com vencimento nominal justamente
hoje); o dado mais urgente desta janela para reavaliar se essa concentração
ainda existe.
...
- **O WASDE finalmente voltar a ser publicado** (35 dias de atraso).

### Leitura operacional — soja

Para quem opera os dois lados, a lacuna de dado hoje é, mais uma vez, a
informação operacional mais relevante: seis pregões reais represados
(sexta, segunda, terça, quarta, quinta e a própria sexta de hoje) — a
abertura de uma segunda semana inteira sem dado — aumentam ainda mais a
probabilidade de um movimento de abertura amplo quando o pregão realmente
voltar a ser refletido no briefing — mais tempo, mais notícia
potencialmente acumulada (COT, RSS, câmbio) para o mercado digerir de uma
só vez, e agora com uma janela maior que qualquer uma desta série. A
leitura de tendência de 4 sessões (-1,39%) sugere viés ligeiramente
baixista de curtíssimo prazo, mas com convicção baixa — a magnitude é
pequena e o hiato de dados, agora o maior desta série, pede cautela extra
...
lado short: um catalisador baixista genuíno (WASDE, COT confirmando
redução de posição, ou ruptura técnica abaixo de 1.155,75) tem potencial de
acelerar mais do que o normal dado esse desenho de posicionamento — e, com
seis pregões represados, o primeiro pregão real após o hiato é o candidato
mais provável para esse tipo de movimento amplo. Para quem opera o físico
...
confirmar ou reverter — e a lacuna de hoje agora soma seis dias úteis
...
### O D+7 chega a 57 dias vencido — e o ratio nunca fechou abaixo de 80% no período recente
...
formal (D+7) caiu em 18/06/2026; hoje, 14/08/2026, são **57 dias corridos**
...
zona. O próximo marco formal é o D+90 (2026-09-09), agora a **26 dias**.
...
agora represado por seis dias úteis inteiros.** 0,6281 USD/bu (03/08) →
...
análises de 08/08 a 13/08: tendência tática em desenvolvimento, ainda não
confirmada por dado que dependa de uma quinta sessão real — que já deveria
ter existido seis vezes (segunda, terça, quarta, quinta, sexta passada e
hoje) e ainda não existe.
...
há sessão nova.** As projeções ABIOVE seguem, sem alteração, mostrando a
...
2026-08-05, agora 9 dias sem atualização.** +0,05 USD/short ton, "mês
...
05/08.** Mato Grosso/IMEA congelado em R$ 1.675,10/ton **há 14 dias**
...
há 9 dias**. Quanto mais tempo passa sem segunda leitura, maior o peso da
ressalva de que pode ser anomalia de coleta, não um novo nível de preço
confirmado — 9 dias sem confirmação já justifica, na visão desta leitura,
...
- **O ratio Far/Soj finalmente fechar abaixo de 80%** após 57 dias sem
...
deveria ter chegado seis vezes (segunda, terça, quarta, quinta, sexta
passada e hoje) — continua ausente, o que efetivamente congela a decisão
por mais um dia útil inteiro, agora abrindo a segunda semana sem
confirmação possível. A recomendação operacional segue a mesma das leituras
anteriores, com peso adicional dado o tamanho do hiato: aguardar a próxima
sessão real antes de ajustar tamanho de posição no spread Far/Soj, e
considerar que, quando essa sessão chegar, ela carrega potencialmente seis
pregões de mercado represado, o que pode produzir um movimento de abertura
maior do que o normal em qualquer direção. Para quem opera o físico de
farelo no RS, a recomendação permanece: não tratar R$ 1.800,00/ton como
preço de mercado confirmado sem uma segunda leitura, e considerar contato
direto com a praça dado que já são 9 dias sem confirmação via o dado
público.
...
sem nenhum dado novo hoje, pelo sexto dia útil seguido, para testar se o
...
mantém essa interpretação como hipótese de trabalho, agora há seis
...
recente, agora 17 dias velha, e olhando as 3 categorias juntas, o óleo é a
...
categoria. Com 17 dias de idade, esse corte é o dado de posicionamento mais
...
seis pregões reais represados (sexta 07/08, segunda 10/08, terça 11/08,
quarta 12/08, quinta 13/08 e a própria sexta 14/08 de hoje), a primeira
sessão real após o hiato carrega risco elevado de gap de abertura em
qualquer direção, o que muda a mecânica prática de onde e como esse stop
deveria estar posicionado (um stop lógico numa cotação intradiária pode não
...
disponível, mas carregam agora oito dias corridos de risco de gap (sexta
que faltou + fim de semana + segunda + terça + quarta + quinta + fim de
semana + hoje) sem atualização de preço para reavaliar. Para quem considera
nova posição comprada, a posição residual dos swap dealers (net long
~88.407 contratos, sem sinal de redução no último corte) é argumento de
...
agora 57 dias vencida.** A recomendação operacional permanece: exigir
...
ausente pelo sexto dia útil seguido, essa confirmação segue impossível de
obter.
...
**ISF em 80/100, ISO em 100/100 — ambos inalterados desde pelo menos 13
...
represados — a segunda semana de pregão inteira sem dado novo desta série —
...
firma ou se dissolve, e chega carregando o peso extra de mais de uma semana
inteira de mercado potencialmente represado.
...
`vigencia_ate` 2026-07-31) — hoje, 2026-08-14 (sexta-feira), completa o
10º dia útil desde o vencimento** (dias úteis decorridos: 03, 04, 05, 06,
07, 10, 11, 12, 13, mais o próprio dia de hoje). Nenhum item do RSS desde
06/08 trouxe informação sobre este tema, e o monitor tributário
(`system/tributario_watch.toml`) segue parado desde 2026-06-05 — **70 dias
...
07/08, mais 10, 11, 12, 13 e hoje 14/08) transcorridas sem confirmação,
este item permanece, nesta leitura, a verificação manual mais urgente do
...
vigência formal venceu há 34 dias** (`vigencia_ate` 11/07/2026), sem
...
plena prevista para 01/09/2026, agora a **18 dias**); INDONESIA-B50
...
**O monitor tributário como um todo está há 70 dias sem qualquer
atualização** — prioridade de manutenção do sistema, especialmente relevante
agora que a isenção PIS/Cofins acumula 10 dias úteis sem confirmação de
status.
...
do mercado — e a gravidade aumentou de novo, abrindo pela primeira vez uma
SEGUNDA semana inteira de pregão sem nenhum dado.** Sexta 07/08, segunda
10/08, terça 11/08, quarta 12/08, quinta 13/08 e a própria sexta 14/08 de
hoje estão ausentes do briefing, e o job que gera `briefing/latest.md`
parece não ter rodado desde 05→06/08, agora 8 dias corridos exatos —
...
uma semana inteira de notícia processada de uma vez.
...
real.** É a primeira vez nesta série que não apenas uma, mas uma sequência
inteira de bandas de curto prazo do sistema expira "no escuro" — reforça,
por um ângulo puramente estatístico-operacional, a urgência da verificação
de pipeline. O forecast de 30 dias gerado em 06/08 (alvo 05/09) segue
formalmente ativo, mas já perdeu, sem possibilidade de recuperação, 8 dos
seus 30 dias de janela sem qualquer verificação.

**O COT (CFTC) referente a 04/08/2026 segue ausente, agora 17 dias desde o
...
corte de 18/08 a apenas 4 dias.** Quando o dado chegar, o ponto mais
...
tese do D+7 (agora 57 dias vencida), ou se rompe para baixo, confirmando-a
com atraso.
...
**A isenção PIS/Cofins do biodiesel completa hoje o 10º dia útil sem
...
leitura de confirmação, agora há 9 dias** — recomendação de contato direto
com a praça.
...
**O WASDE segue fora da janela deste briefing, agora 35 dias de atraso**
desde o último dado (10/07/2026).

**Danantara (Indonésia) assume plenamente a cadeia de exportação de palma
em 01/09/2026, a 18 dias de hoje** — monitorar se a curva do óleo CBOT
...
recente é de 2026-08-06 (lido em 2026-08-14), e os pontos onde a confiança
é baixa:

**1. O achado central desta leitura, agora pela oitava vez seguida e com
...
ontem (13/08), o hiato já somava cinco pregões reais perdidos e fechava a
primeira semana útil inteira sem dado. **Hoje, sexta-feira 14/08, o hiato
soma seis sessões reais consecutivas ausentes — sexta 07/08, segunda 10/08,
terça 11/08, quarta 12/08, quinta 13/08 e a própria sexta 14/08 de hoje —,
e o calendário abre, pela primeira vez desta série, uma SEGUNDA semana de
pregão inteira nesse estado.** O padrão — ausência total e uniforme em
todas as fontes, não apenas na CBOT, e agora persistente por seis dias
úteis consecutivos — é incompatível com qualquer hipótese de atraso pontual
de uma única fonte, e aponta com a convicção mais alta desta série inteira
para o job que gera `briefing/latest.md` não ter rodado desde a noite de
05→06/08. Esta leitura recomenda, pela oitava vez e agora com a prioridade
mais alta de toda a série, verificação técnica direta do pipeline de coleta
...
verificação, e hoje esse custo ganhou um componente novo e concreto: não
um, mas QUATRO forecasts estatísticos de 7 dias gerados nesta mesma base
(06/08 e nos três dias anteriores) tinham alvos entre 10 e 13/08 — todos já
passados — e expiram, deste modo, sem jamais terem sido testados contra um
único fechamento real.
...
classificação não pôde avançar desde a leitura de 13/08.
...
recente, agora 17 dias sem atualização — mais que o dobro do intervalo
...
tiver ocorrido nos seis pregões represados.

**5. O prêmio de exportação de Paranaguá (soja) e o CEPEA Paraná interior
não trouxeram carimbo novo desde 2026-08-05** — agora 9 dias sem
atualização.
...
**10. O ratio Far/Soj (80,60%) segue sem fechar abaixo de 80%, agora 57
...
D+90 (2026-09-09, a 26 dias) como próximo marco formal.
...
caducidade neste briefing, completando hoje o 10º dia útil sem status.** O
monitor tributário está 70 dias sem atualização; esta leitura não presume
nenhum dos dois cenários.

**13. O WASDE permanece completamente fora da janela deste briefing** —
agora 35 dias de atraso desde o último dado (10/07/2026).
...
pipeline cobriu inteiramente as quatro janelas de vigência.** É o primeiro
caso nesta série em que não um, mas uma sequência completa de forecasts
formais do sistema expira "no escuro". O forecast de 30 dias gerado em
06/08 (alvo 2026-09-05) segue formalmente ativo, mas já perdeu, sem
possibilidade de recuperação, os primeiros 8 dos seus 30 dias de janela sem
...
lido em 2026-08-14 e nos insights anteriores referenciados. A contribuição
central desta leitura foi (1) registrar que a ausência de dado novo abriu,
pela primeira vez nesta série, uma SEGUNDA semana de pregão inteira sem
nenhum dado (seis sessões represadas: 07, 10, 11, 12, 13 e 14/08, oito dias
corridos desde o último carimbo real); (2) registrar que não um, mas QUATRO
forecasts estatísticos de 7 dias gerados em sequência (03 a 06/08, alvos 10
a 13/08) expiraram, um atrás do outro, sem nunca terem sido confrontados
com um único fechamento real; (3) recalcular com precisão todos os
contadores de dias da fila de julgamento e da lente fiscal (D+7 agora a 57
dias, D+90 a 26 dias, PIS/Cofins completando o 10º dia útil sem status, MP
1.358 a 34 dias, WASDE a 35 dias de atraso, monitor tributário a 70 dias,
RS sem segunda leitura há 9 dias, COT a 17 dias, Danantara a 18 dias); e (4)
...
`release-nopa-2026-08-06` — no contexto específico de uma segunda semana de
pregão inteira sem sessão nova, sem inventar confirmação, tonelagem ou
percentil que o briefing não trouxe.*
