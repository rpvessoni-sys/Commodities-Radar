---
data: 2026-08-11
titulo: "Terça-feira 11/08 chega e o pipeline segue travado em 06/08 — agora são TRÊS pregões reais consecutivos perdidos (sexta 07, segunda 10, terça 11), o que descarta de vez a hipótese de calendário, enquanto os mesmos 4 pregões genuinamente conhecidos (03→06/08) continuam mostrando farelo ganhando força relativa dentro do crush (oil-meal spread -5,4% acumulado) e óleo preso abaixo do suporte técnico rompido (67,60 vs 72,00)"
tags: [complexo, auto-claude]
fontes:
  - CME CBOT (ZSU26 soja / ZMU26 farelo / ZLU26 óleo) — sessão de 2026-08-06 (quinta-feira), a MESMA sessão já usada nas leituras de 2026-08-07, 08-08, 08-09 e 08-10; hoje é terça-feira 2026-08-11, segundo dia útil pleno seguido sem nenhum carimbo novo — ver Honestidade
  - CME CBOT — série completa dos últimos 4 pregões genuinamente conhecidos (2026-08-03, 08-04, 08-05, 08-06), usada nesta leitura para tendência multi-sessão
  ...
  - BCB PTAX — carimbo mais recente 2026-08-05 (USD/BRL 5,1154); agora 6 dias corridos sem atualização
  - CEPEA/ESALQ Soja Paranaguá via NAG — carimbo mais recente 2026-08-05, R$ 144,91/saca; 6 dias sem atualização
  - CEPEA/ESALQ Soja Paraná interior via NAG — carimbo mais recente 2026-08-05, R$ 136,73/saca
  - NAG Físico BR — carimbo mais recente 2026-08-05 (farelo MT/IMEA R$ 1.675,10/ton, congelado há 11 dias desde 31/07; Rondonópolis/MT R$ 1.700,00/ton, mesmo congelamento; RS R$ 1.800,00/ton, agora 6 dias sem segunda leitura de confirmação); prêmios export PGUA farelo (+0,05 USD/sht) e óleo (+0,08 cts/lb), carimbo 2026-08-05, "mês Agosto/26"
  - CFTC COT Managed Money, Swap Dealers e Producer/Merchant — corte de 2026-07-28, agora 14 dias sem atualização — o dobro do ciclo semanal normal
  - USDA Crop Progress — corte rotulado 2026-08-02, mesmos valores do corte de 2026-07-26 (11% excelente / 52% boa / 7% ruim), oitava leitura seguida sem mudança
  - USDA WASDE — ausente da janela, agora 32 dias de atraso desde o último dado (2026-07-10)
  ...
  - system/tributario_watch.toml (lido como referência, não editado) — `atualizado_em` 2026-06-05, agora 67 dias sem atualização
  ...
  - Cruza com [[2026-08-10_leitura-complexo]], [[2026-08-09_leitura-complexo]], [[2026-08-08_leitura-complexo]], [[2026-08-07_leitura-complexo]] e [[2026-06-11_ratio-81-prepara-janela-de-tranches-farelo]] (tese original do D+7, checkpoint segue vencido)
status: ativa
...
**Hoje é terça-feira, 2026-08-11 — o segundo dia útil pleno seguido de
pregão normal na CBOT — e o fato mais importante desta leitura, pela quinta
vez consecutiva, continua sendo estrutural, não de mercado: o briefing lido
hoje ainda traz o fechamento de quinta-feira, 2026-08-06, como o dado mais
recente de CBOT, PTAX, físico NAG, COT e RSS.** As quatro leituras
anteriores (07/08, 08/08, 09/08, 10/08) já haviam registrado essa ausência
crescente, e a de ontem (10/08) já havia notado que o argumento de
calendário parava de se sustentar a partir daquela segunda-feira. **Hoje
esse argumento fica ainda mais insustentável: 11/08 é o SEGUNDO dia útil
pleno seguido sem um único carimbo novo em nenhuma fonte, o que eleva a
contagem de pregões reais genuinamente perdidos de dois para TRÊS — sexta
07/08, segunda 10/08 e a própria terça 11/08 — com o fim de semana inteiro
no meio sem qualquer atualização registrada nesse intervalo.** Isso muda a
natureza do diagnóstico outra vez: "um pregão pode ter ficado de fora por
atraso pontual de coleta" já não fazia sentido ontem, e "dois pregões
perdidos com um fim de semana no meio" ainda podia, em tese, refletir um
problema que se resolveria sozinho na reabertura normal da semana. Hoje, com
uma SEGUNDA segunda-feira útil (na prática, o segundo dia útil consecutivo)
também sem carimbo novo, o padrão deixa de ser compatível com qualquer
explicação de atraso pontual e passa a apontar, com convicção cada vez
maior, para uma falha de execução persistente do job que gera
`briefing/latest.md` — que parece não ter rodado desde a noite de 05→06/08,
ou seja, há agora 5 dias corridos. Esta leitura mantém o tratamento desse
achado como o mais acionável do dia, à frente de qualquer conclusão sobre
preço — ver Honestidade para o detalhamento completo e a recomendação de
verificação técnica direta, agora com prioridade máxima dado o tamanho do
hiato.
...
identificada nas quatro leituras anteriores, e que esta análise aprofunda
mais uma vez porque é, literalmente, o único material novo disponível para
interpretar: o oil-meal spread (quanto o óleo vale a mais que o farelo
...
Suporte do Óleo (ISO) em 100/100 — não mudam há pelo menos 11 dias corridos
(desde 31/07 até o carimbo de 06/08, e sem novo carimbo desde então), porque
...
segue sendo duplo — de um lado, a lacuna de dado deixou de ser sequer um
"detalhe estrutural incômodo" e virou o evento dominante de toda a semana
(três pregões reais perdidos, não mais dois, e o argumento de calendário já
esgotado desde ontem); do outro, a única informação de mercado disponível,
lida em janela de 4 sessões em vez de 1 dia, continua mostrando farelo
...
de 4 sessões (o mesmo conjunto de pontos de dado das últimas quatro
leituras, sem nenhum ponto novo para reforçá-la ou refutá-la), e confiança
muito baixa — agora a mais baixa desta série inteira — sobre o que
efetivamente aconteceu com o preço entre a tarde de 06/08 e agora, um hiato
que já soma 5 dias corridos e 3 sessões reais de mercado.
...
sessões (03→06/08, -1,39% acumulado) — a mesma leitura híbrida das quatro
...
resolveu — e hoje, terça-feira, já deveriam ter existido pelo menos DUAS
novas sessões (segunda e terça) para testar isso, e não existe nenhuma.**
Abertura 1.157,25, máxima 1.158,50, mínima 1.155,75, fechamento 1.157,50 —
amplitude de apenas 2,75 pontos, um quarto dos 13,00 pontos do pregão
anterior (05/08). **Mecanismo:** compressão de amplitude tende, em teoria
técnica de mercado, a preceder um movimento mais amplo quando aparece o
catalisador — e agora há TRÊS catalisadores represados que não chegaram (o
COT da semana passada, que normalmente sairia numa sexta; a reabertura de
segunda-feira; e a própria sessão de hoje, terça), o que reforça ainda mais
a hipótese de represamento técnico sem, no entanto, confirmá-la — a
...
momentum" do que com "topo lateral neutro", ainda que a magnitude (-1,39%
em quase 2 semanas corridas) seja pequena para qualificar como tendência
forte.

**A curva futura, na última leitura disponível, seguia em contango
regular, sem sinal de aperto de oferta prompt.** Q26 (ago/26) 1.151,75, U26
(set/26) 1.157,50, X26 (nov/26) 1.175,75, F27 (jan/27) 1.191,00, H27
(mar/27) 1.197,00, K27 (mai/27) 1.205,25 — cada vencimento mais distante
vale mais que o anterior, o formato normal quando não há escassez imediata
percebida. O spread K27-Q26 (53,50 pontos) tinha se mantido estável frente
ao pregão anterior (54,50 em 05/08). Sem sessão de sexta, segunda ou hoje,
esta leitura não tem como saber se esse formato persistiu — e, relevante
para quem monitora spreads de calendário, três pregões represados
significam que qualquer ajuste de curva que tenha ocorrido no intervalo
pode aparecer de uma vez, como um salto maior do que o normal, na próxima
sessão real, em vez de gradualmente distribuído ao longo de três dias.

**O câmbio permanece com o mesmo carimbo de quarta-feira (05/08), agora há
6 dias sem atualização — mas a série das duas semanas anteriores ao hiato
...
câmbio de sexta, sábado, domingo, segunda ou hoje não está capturado neste
número — e, como o USD/BRL é o canal mais direto entre o CBOT em dólares e o
preço físico em reais, essa é, junto com o próprio CBOT, a lacuna mais
relevante para quem decide originação ou hedge cambial hoje.
...
das últimas 2 semanas: de R$ 148,37/saca (24/07) para R$ 144,04/saca
(03/08) — -2,92% em 8 pregões — antes de recuperar levemente para R$
144,91/saca (05/08, carimbo mais recente, agora 6 dias parado).
...
**O posicionamento do COT (CFTC) segue no corte de 28/07/2026, agora 14
dias sem atualização — o dobro do ciclo semanal normal — e a leitura das
três categorias juntas continua mostrando concentração especulativa
...
1.020.108). Os swap dealers (posições de índice/passivos repassadas via
swap) também estavam líquidos comprados: swap long 148.653 menos swap short
42.713 = net long de **105.940 contratos** — quase dois terços do tamanho
da posição do managed money. Somando as duas categorias não-comerciais, o
net long combinado chega a **~266.419 contratos**, compensado quase
inteiramente pelos produtores/comerciais (producer long 283.941, producer
short 582.088, net **-298.147**, líquido vendido, como esperado de hedge de
produção física). **Mecanismo e leitura:** essa concentração — duas
categorias especulativas grandes do lado comprado contra uma única
categoria de hedge do lado vendido — é a estrutura clássica que precede
liquidações mais bruscas quando aparece um catalisador baixista: se o
preço cair o suficiente para acionar stops ou margem nos fundos, tanto o
managed money quanto os swap dealers têm posição a reduzir na mesma
direção, o que amplificaria qualquer queda. O corte tem agora 14 dias — dois
ciclos semanais completos sem renovação. O próximo corte (nominalmente já
deveria ter saído em 07/08 ou 14/08) é o dado mais urgente desta janela para
reavaliar se essa concentração ainda existe.

### O que invalida / risco para a soja

- **As sessões represadas (07, 10 e 11/08) aparecerem retroativamente num
  briefing futuro** fora do range de 1.155,75-1.158,50 — romperia a
  consolidação e definiria a primeira direção nova desde 04/08.
- **A queda acumulada de 4 sessões (-1,39%) se estender por mais 2-3
  pregões quando o pregão real voltar** — mudaria a leitura de "baixa
  perdendo momentum" para "tendência de baixa em curso".
...
- **O WASDE finalmente voltar a ser publicado** (32 dias de atraso).

### Leitura operacional — soja

Para quem opera os dois lados, a lacuna de dado hoje é, mais uma vez, a
informação operacional mais relevante: três pregões reais represados
(sexta, segunda e a própria terça de hoje) aumentam ainda mais a
probabilidade de um movimento de abertura amplo quando o pregão realmente
voltar a ser refletido no briefing — mais tempo, mais notícia potencialmente
acumulada (COT, RSS, câmbio) para o mercado digerir de uma só vez, e agora
com uma janela maior que qualquer uma desta série. A leitura de tendência de
4 sessões (-1,39%) sugere viés ligeiramente baixista de curtíssimo prazo,
mas com convicção baixa — a magnitude é pequena e o hiato de dados, agora o
maior desta série, pede cautela extra antes de dimensionar posição nova. A
concentração de posição comprada em managed money + swap dealers é um
argumento de contexto para quem avalia o lado short: um catalisador
baixista genuíno (WASDE, COT confirmando redução de posição, ou ruptura
técnica abaixo de 1.155,75) tem potencial de acelerar mais do que o normal
dado esse desenho de posicionamento — e, com três pregões represados, o
primeiro pregão real após o hiato é o candidato mais provável para esse
tipo de movimento amplo. Para quem opera o físico brasileiro, a
recomendação permanece: buscar confirmação direta na praça da manchete de
máxima do ano antes de qualquer decisão de originação, usando o basis
prático do dono, não a manchete, como referência.
...
confirmar ou reverter — e a lacuna de hoje agora soma dois dias úteis
seguidos em que essa quinta confirmação deveria ter chegado e não chegou,
o que torna esse o sinal mais "represado" de toda a leitura.** Trata
...
### O D+7 chega a 54 dias vencido — e o ratio nunca fechou abaixo de 80% no período recente
...
formal (D+7) caiu em 18/06/2026; hoje, 11/08/2026, são **54 dias corridos**
...
zona. O próximo marco formal é o D+90 (2026-09-09), agora a **29 dias**.

### O que sustenta a leitura de hoje

**O oil-meal spread caiu em todas as 4 últimas sessões conhecidas — o sinal
mais forte desta leitura, e o que mais precisa de confirmação com dado
novo, agora represada por dois dias úteis inteiros.** 0,6281 USD/bu (03/08)
...
análises de 08/08, 09/08 e 10/08: tendência tática em desenvolvimento,
ainda não confirmada por dado que dependa de uma quinta sessão real — que já
deveria ter existido duas vezes (segunda e hoje) e ainda não existe.

**A crush margin, na última leitura disponível, também cedeu nas 4
sessões, embora de forma menos linear.** 2,7682 USD/bushel (03/08) → 2,7939
(04/08, único dia de alta) → 2,7043 (05/08) → 2,7030 (06/08) — queda
acumulada de **-2,36% em 4 sessões**, ainda folgada frente ao nível de
alerta histórico (<2,50 USD/bu), com margem de segurança de ~8% acima do
gatilho. **Mecanismo:** enquanto a margem de papel (CBOT) segue folgada, a
...
deste briefing (pelo menos 31/07 a 06/08, ou seja, 11 dias corridos sem um
...
2026-08-05, agora 6 dias sem atualização.** +0,05 USD/short ton, "mês
...
05/08.** Mato Grosso/IMEA congelado em R$ 1.675,10/ton **há 11 dias** (desde
...
**segue sem uma segunda leitura de confirmação, agora há 6 dias**. Quanto
mais tempo passa sem segunda leitura, maior o peso da ressalva de que pode
ser anomalia de coleta, não um novo nível de preço confirmado — 6 dias sem
...
- **O ratio Far/Soj finalmente fechar abaixo de 80%** após 54 dias sem
...
deveria ter chegado duas vezes, segunda e hoje — continua ausente, o que
efetivamente congela a decisão por mais um dia útil inteiro. A recomendação
operacional segue a mesma das leituras anteriores, com peso adicional dado
o tamanho crescente do hiato: aguardar a próxima sessão real antes de
ajustar tamanho de posição no spread Far/Soj, e considerar que, quando essa
sessão chegar, ela carrega potencialmente três pregões de mercado
represado, o que pode produzir um movimento de abertura maior do que o
normal em qualquer direção. Para quem opera o físico de farelo no RS, a
...
dado que já são 6 dias sem confirmação via o dado público.
...
sem nenhum dado novo hoje, pelo segundo dia útil seguido, para testar se o
...
(-1,40%) na mesma janela.** **Mecanismo:** confirmação, com dados de
múltiplas sessões e não de um único candle, de que o mercado vendeu óleo
mais agressivamente do que os outros dois pernas do complexo — coerente com
a curva em backwardation e com o rompimento do suporte técnico de 72,00. Em
nível, 67,60 está -6,11% abaixo desse suporte — a distância mais recente
conhecida, sem confirmação de sessão nova por já três pregões reais
represados.
...
mantém essa interpretação como hipótese de trabalho, agora há três pregões
sem poder testá-la.
...
(pelo menos 31/07 a 06/08, 11 dias corridos sem mudança).** A tese
...
recente, agora 14 dias velha, e olhando as 3 categorias juntas, o óleo é a
...
categoria. Com 14 dias de idade, esse corte é o dado de posicionamento mais
...
três pregões reais represados (sexta 07/08, segunda 10/08 e a própria terça
11/08), a primeira sessão real após o hiato carrega risco elevado de gap de
abertura em qualquer direção, o que muda a mecânica prática de onde e como
esse stop deveria estar posicionado (um stop lógico numa cotação
intradiária pode não capturar um gap que abre diretamente acima ou abaixo
do nível). A leitura de que o aprofundamento da backwardation vinha do fim
da curva, não do início, continua relevante para quem opera spreads de
...
disponível, mas carregam agora cinco dias corridos de risco de gap (sexta
que faltou + fim de semana + segunda + hoje) sem atualização de preço para
reavaliar. Para quem considera nova posição comprada, a posição residual
dos swap dealers (net long ~88.407 contratos, sem sinal de redução no
último corte) é argumento de cautela adicional: ainda há posição
especulativa "gorda" que pode ser liquidada se a queda técnica continuar,
o que favorece mais o lado vendido no curto prazo do que uma aposta
contrária.
...
agora 54 dias vencida.** A recomendação operacional permanece: exigir
confirmação por mais de uma sessão seguida na mesma direção antes de
tratar qualquer nível como sinal robusto — e hoje, com a quinta sessão
ainda ausente pelo segundo dia útil seguido, essa confirmação segue
impossível de obter.
...
**ISF em 80/100, ISO em 100/100 — ambos inalterados por pelo menos 11 dias
...
estruturalmente favorecido na captura de valor do crush, mas os
componentes táticos, quando lidos em janela de 4 sessões em vez de 1 dia,
mostram um movimento consistente na direção oposta à tese estrutural:
farelo ganhando força relativa (oil-meal spread -5,43% em 4 sessões)
enquanto o preço do óleo cai mais rápido que os demais (-1,73% em 4
sessões). Isso não é uma contradição — mede-se aqui duas coisas diferentes
(quem "domina" o valor do crush no longo prazo vs. quem está sendo mais
vendido no curto prazo) — mas é a tensão mais relevante do complexo nesta
leitura. Com três pregões reais represados, essa tensão fica sem teste
novo por mais um dia: a próxima sessão real, sempre que o pipeline voltar a
rodar, decide se o sinal tático do farelo se firma ou se dissolve.
...
`vigencia_ate` 2026-07-31) — hoje, 2026-08-11 (terça-feira), completa o
7º dia útil desde o vencimento** (dias úteis decorridos: 03, 04, 05, 06, 07
e 10/08, mais o próprio dia de hoje). Nenhum item do RSS desde 06/08 trouxe
informação sobre este tema, e o monitor tributário
(`system/tributario_watch.toml`) segue parado desde 2026-06-05 — **67 dias
...
última leitura disponível. Com mais de uma semana e meia de pregões (03 a
07/08, mais 10 e hoje 11/08) transcorrida sem confirmação, este item
...
vigência formal venceu há 31 dias** (`vigencia_ate` 11/07/2026), sem
...
plena prevista para 01/09/2026, agora a **21 dias**); INDONESIA-B50
...
**O monitor tributário como um todo está há 67 dias sem qualquer
atualização** — prioridade de manutenção do sistema, especialmente relevante
agora que a isenção PIS/Cofins acumula 7 dias úteis sem confirmação de
status.
...
do mercado — e a gravidade aumentou de novo.** Três pregões reais (sexta
07/08, segunda 10/08 e a própria terça 11/08) estão ausentes do briefing, e
o job que gera `briefing/latest.md` parece não ter rodado desde 05→06/08,
agora 5 dias corridos — recomendação de verificação técnica direta, com
prioridade máxima, antes de tratar qualquer gap de preço na próxima
abertura refletida como movimento de mercado genuíno, e não como acúmulo de
vários dias de notícia processados de uma vez.

**O COT (CFTC) referente a 04/08/2026 segue ausente, agora 14 dias desde o
último corte (28/07) — exatamente o dobro do intervalo semanal normal —, e
o corte seguinte (nominalmente de 11/08) já deveria estar publicado hoje.**
...
tese do D+7 (agora 54 dias vencida), ou se rompe para baixo, confirmando-a
com atraso.
...
**A isenção PIS/Cofins do biodiesel completa hoje o 7º dia útil sem
...
leitura de confirmação, agora há 6 dias** — recomendação de contato direto
com a praça.

**O USDA Crop Progress rotulado 2026-08-02 segue com os MESMOS valores do
corte de 26/07**, agora pela oitava leitura seguida; o próximo corte,
...
**O WASDE segue fora da janela deste briefing, agora 32 dias de atraso**
desde o último dado (10/07/2026).

**Danantara (Indonésia) assume plenamente a cadeia de exportação de palma
em 01/09/2026, a 21 dias de hoje** — monitorar se a curva do óleo CBOT
...
recente é de 2026-08-06 (lido em 2026-08-11), e os pontos onde a confiança
é baixa:

**1. O achado central desta leitura, agora pela quinta vez seguida e com
uma nova mudança de natureza: nenhuma fonte do briefing trouxe dado novo
desde a sessão de 2026-08-06 — nem CBOT, nem PTAX, nem NAG físico, nem COT,
nem RSS, nem INMET, nem ENSO, nem MPOB, nem BCBA.** Na leitura de ontem
(10/08), o argumento de calendário já havia deixado de se sustentar, porque
segunda-feira é dia útil pleno. **Hoje, terça-feira 11/08, esse argumento
fica ainda mais insustentável: é o SEGUNDO dia útil consecutivo sem
qualquer carimbo novo**, o que eleva a contagem real de pregões perdidos de
"2 (sexta e segunda)" para "3 (sexta, segunda e a própria terça de hoje)",
com um fim de semana inteiro no meio sem qualquer atualização registrada.
O padrão — ausência total e uniforme em todas as fontes, não apenas na
CBOT, e agora persistente por dois dias úteis consecutivos — é
incompatível com qualquer hipótese de atraso pontual de uma única fonte, e
aponta com convicção crescente para o job que gera `briefing/latest.md` não
ter rodado desde a noite de 05→06/08. Esta leitura recomenda, pela quinta
vez e agora com a prioridade mais alta de toda a série, verificação técnica
direta do pipeline de coleta (`main.py` / scraper CME / agendador do job)
antes de mais um ciclo de leitura ser gerado sobre o mesmo dado de 06/08.
...
classificação não pôde avançar desde a leitura de 10/08.
...
recente, agora 14 dias sem atualização — exatamente o dobro do intervalo
...
(managed money + swap dealers) usa dado de duas semanas de idade — pode já
estar desatualizada, especialmente se um catalisador de mercado tiver
ocorrido nos três pregões represados.

**5. O prêmio de exportação de Paranaguá (soja) e o CEPEA Paraná interior
não trouxeram carimbo novo desde 2026-08-05** — agora 6 dias sem
atualização.
...
incluindo qualquer variação de sexta, segunda ou de hoje.
...
**10. O ratio Far/Soj (80,60%) segue sem fechar abaixo de 80%, agora 54
...
D+90 (2026-09-09, a 29 dias) como próximo marco formal.

**11. O USDA Crop Progress rotulado 2026-08-02 trouxe, pelo oitavo dump
...
caducidade neste briefing, completando hoje o 7º dia útil sem status.** O
monitor tributário está 67 dias sem atualização; esta leitura não presume
nenhum dos dois cenários.

**13. O WASDE permanece completamente fora da janela deste briefing** —
agora 32 dias de atraso desde o último dado (10/07/2026).
...
qualitativa de hoje. Vale notar que o horizonte de 7 dias gerado em 06/08
tem alvo em 2026-08-13 — hoje, 11/08, já se passaram 5 dos 7 dias daquela
janela sem um único ponto de dado novo para testar a banda, o que reduz
ainda mais a utilidade prática desse forecast específico até o pipeline
normalizar; restam apenas 2 dias corridos até o alvo, e se o hiato não se
resolver antes disso, a banda de 7 dias expira sem nunca ter sido testada
contra dado real.

*Nenhum número foi inventado ou estimado além do que consta no briefing
lido em 2026-08-11 e nos insights anteriores referenciados. A contribuição
central desta leitura foi (1) registrar que a ausência de dado novo se
agravou de novo — hoje é o segundo dia útil consecutivo sem sessão nova, o
que eleva o hiato de dois para três pregões reais represados (sexta 07/08,
segunda 10/08 e a própria terça 11/08), descartando de forma ainda mais
completa qualquer explicação de calendário; (2) recalcular com precisão
todos os contadores de dias da fila de julgamento e da lente fiscal (D+7
agora a 54 dias, D+90 a 29 dias, PIS/Cofins completando o 7º dia útil sem
status, MP 1.358 a 31 dias, WASDE a 32 dias de atraso, monitor tributário a
67 dias, RS sem segunda leitura há 6 dias, COT a 14 dias, Danantara a 21
dias); e (3) manter a leitura de tendência de 4 sessões (03→06/08) como o
...
`release-nopa-2026-08-06` — no contexto específico de um segundo dia útil
seguido sem sessão nova, sem inventar confirmação, tonelagem ou percentil
