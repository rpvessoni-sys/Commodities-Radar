---
data: 2026-08-25
titulo: "Terça-feira 25/08 é o segundo dia dentro da terceira semana útil inteira sem pregão novo — 19 dias corridos, 13 sessões reais represadas — e o farelo com força tática (oil-meal spread -5,4% em 4 sessões) contra o óleo em quebra técnica sob 72,00 seguem sendo a única informação de mercado disponível"
tags: [complexo, auto-claude]
fontes:
  - CME CBOT (ZSU26 soja / ZMU26 farelo / ZLU26 óleo) — sessão de 2026-08-06 (quinta-feira), a MESMA sessão usada em todas as leituras desde 2026-08-07; hoje é terça-feira 2026-08-25, o segundo dia útil dentro da terceira semana de calendário completa (24-28/08) que o hiato já havia aberto ontem — ver Honestidade
  - CME CBOT — série completa dos últimos 4 pregões genuinamente conhecidos (2026-08-03, 08-04, 08-05, 08-06), única janela de tendência de mercado disponível, idêntica à usada nas dezoito leituras anteriores
  ...
  - BCB PTAX — carimbo mais recente 2026-08-05 (USD/BRL 5,1154); agora 20 dias corridos sem atualização
  - CEPEA/ESALQ Soja Paranaguá via NAG — carimbo mais recente 2026-08-05, R$ 144,91/saca; 20 dias sem atualização
  - CEPEA/ESALQ Soja Paraná interior via NAG — carimbo mais recente 2026-08-05, R$ 136,73/saca; 20 dias sem atualização
  - NAG Físico BR — carimbo mais recente 2026-08-05 (farelo MT/IMEA R$ 1.675,10/ton, congelado desde 31/07, agora 25 dias; Rondonópolis/MT R$ 1.700,00/ton, mesmo congelamento; RS R$ 1.800,00/ton, agora 20 dias corridos sem segunda leitura de confirmação); prêmios export PGUA farelo (+0,05 USD/sht) e óleo (+0,08 cts/lb), carimbo 2026-08-05, "mês Agosto/26"
  - CFTC COT Managed Money, Swap Dealers e Producer/Merchant — corte de 2026-07-28, agora 28 dias sem atualização
  - USDA Crop Progress — corte rotulado 2026-08-02, mesmos valores do corte de 2026-07-26 (11% excelente / 52% boa / 7% ruim)
  - USDA WASDE — ausente da janela, agora 46 dias de atraso desde o último dado (2026-07-10)
  ...
  - Forecasts estatísticos internos (bandas 7d/30d, MA20+volatilidade+slope) — geração mais recente 2026-08-06; as QUATRO bandas de 7 dias geradas em 03, 04, 05 e 06/08 (alvos 10, 11, 12 e 13/08) seguem vencidas sem nunca terem sido testadas; o forecast de 30d (alvo 05/09) já consumiu 19 dos seus 30 dias de janela sem qualquer verificação — ver Honestidade
  - system/tributario_watch.toml (lido como referência, não editado) — `atualizado_em` 2026-06-05, agora 81 dias sem atualização
  ...
  - Calendário (cálculo próprio, sem fonte externa): 2026-08-25 é terça-feira — confirmado por conversão de calendário gregoriano, não por dado do briefing
  - Cruza com [[2026-08-24_leitura-complexo]], [[2026-08-23_leitura-complexo]], [[2026-08-22_leitura-complexo]] e [[2026-06-11_ratio-81-prepara-janela-de-tranches-farelo]] (tese original do D+7, checkpoint segue vencido)
status: ativa
...
**Hoje é terça-feira, 2026-08-25 — o segundo dia útil dentro da terceira
semana de calendário inteira (24-28/08) que o hiato já havia formalmente
alcançado ontem.** Ontem, segunda-feira 24/08, foi o dia em que o hiato
ultrapassou seu patamar mais grave até então — o primeiro dia útil de uma
terceira semana cheia sem pregão desde 06/08. Hoje não é mais um novo
recorde de gravidade estrutural (esse já foi cravado ontem), mas é mais um
dia em que o teste não se resolveu: o briefing continua parado exatamente no
mesmo fechamento de quinta-feira, 2026-08-06, e o contador segue avançando.
Com o fechamento de hoje, o hiato soma **19 dias corridos** (06→25/08, +1
frente a ontem) e **13 sessões reais de pregão represadas** (as doze já
contadas — 07, 10, 11, 12, 13, 14, 17, 18, 19, 20, 21 e 24/08 — mais a
própria terça-feira 25/08, que deveria ter gerado pregão hoje e não gerou).
Esta é a **19ª leitura diária consecutiva** (07 a 25/08) escrita sobre o
mesmo fechamento de quinta-feira, 06/08 — a segunda a cair dentro da terceira
semana útil cheia sem dado (a primeira foi 10-14/08, a segunda 17-21/08, e
24-28/08 é a terceira, hoje em seu segundo dia).
...
identificada nas dezoito leituras anteriores, e que esta análise revisita
...
segue sendo o próprio hiato de dado — pela 19ª vez seguida o evento mais
material desta leitura —, com maior convicção nos mecanismos estruturais
(ISF, ISO, ABIOVE) que independem do calendário, confiança moderada na
tendência tática de 4 sessões (o mesmo conjunto de pontos de dado das
últimas dezoito leituras, sem nenhum ponto novo para reforçá-la ou
refutá-la), e confiança mínima sobre o que efetivamente aconteceu com o
preço entre a tarde de 06/08 e agora, um intervalo que já cobre 19 dias
corridos e 13 sessões reais de mercado sem qualquer verificação.
...
sessões (03→06/08, -1,39% acumulado) — a mesma leitura híbrida das dezoito
análises anteriores, agora pela 19ª vez sem nenhum dado adicional para
...
o catalisador — e com treze sessões represadas mais dois, três ou
possivelmente já quatro cortes de COT que já deveriam ter saído (semanas de
04/08, 11/08, 18/08 e possivelmente 21/08), essa hipótese de represamento
técnico segue reforçada, mas não confirmada, porque não há dado novo desde
06/08. O primeiro dia útil que testaria a resolução do hiato dentro desta
semana já passou (ontem, segunda 24/08) e não trouxe dado novo; hoje, o
segundo dia, repete o mesmo resultado.
...
forte. Com o hiato agora somando 13 sessões reais represadas, essa
magnitude relativamente pequena carrega um risco extra que só cresce: se o
mercado tiver, de fato, continuado a ceder nos treze pregões represados na
...
saber se esse formato persistiu — e treze pregões represados significam que
...
gradualmente distribuído ao longo de quase três semanas.

**O câmbio permanece com o mesmo carimbo de quarta-feira (05/08), agora há
20 dias sem atualização — mas a série das duas semanas anteriores ao hiato
...
144,91/saca (05/08, carimbo mais recente, agora 20 dias parado).
...
**O posicionamento do COT (CFTC) segue no corte de 28/07/2026, agora 28
...
queda. O corte tem agora 28 dias — quatro semanas completas. Já deveriam ter
...
- **As sessões represadas (07, 10, 11, 12, 13, 14, 17, 18, 19, 20, 21, 24 e
  25/08) aparecerem retroativamente num briefing futuro** fora do range de
...
- **O WASDE finalmente voltar a ser publicado** (46 dias de atraso).

### Leitura operacional — soja

Para quem opera os dois lados, o hiato de dado já está no segundo dia da
terceira semana útil inteira sem dado: treze pregões reais represados
...
mais do que o normal dado esse desenho de posicionamento — e, com treze
pregões represados já acumulados sem nenhum sinal de retomada do pipeline,
qualquer reabertura carrega risco elevado de gap. Para quem opera o físico
...
confirmar ou reverter — e, com o hiato já dentro de sua terceira semana útil
inteira, esse continua sendo o sinal mais "represado" de toda a leitura pela
19ª vez seguida.** Trata
...
### O D+7 chega a 68 dias vencido — e o ratio nunca fechou abaixo de 80% no período recente
...
formal (D+7) caiu em 18/06/2026; hoje, 25/08/2026, são **68 dias corridos**
...
zona. O próximo marco formal é o D+90 (2026-09-09), agora a **15 dias**.
...
agora represado por treze sessões reais inteiras.** 0,6281 USD/bu (03/08) →
...
ter existido treze vezes, e ainda não existe.
...
**O posicionamento do COT em farelo, no mesmo corte de 28/07 (28 dias de
...
sugeriria — outro motivo pelo qual o COT atrasado (28 dias, o mais velho
...
2026-08-05, agora 20 dias sem atualização.** +0,05 USD/short ton, "mês
...
05/08.** Mato Grosso/IMEA congelado em R$ 1.675,10/ton **há 25 dias**
...
há 20 dias**. Quanto mais tempo passa sem segunda leitura, maior o peso da
ressalva de que pode ser anomalia de coleta, não um novo nível de preço
confirmado — 20 dias sem confirmação já justifica, na visão desta leitura,
...
- **O ratio Far/Soj finalmente fechar abaixo de 80%** após 68 dias sem
...
ausente — e a sessão de hoje, que seria mais uma chance real de obtê-la,
também não trouxe dado novo. A recomendação operacional segue a mesma das
leituras anteriores: aguardar a próxima sessão real antes de ajustar tamanho
de posição no spread Far/Soj. A posição especulativa comprada relevante em
farelo (managed money + swap dealers ~200.221 contratos, dado de 28 dias) é
...
contato direto com a praça dado que já são 20 dias sem confirmação via o
dado público.
...
de sessão nova por já treze pregões reais represados.
...
possível por treze pregões, incluindo três fins de semana inteiros e o
segundo dia da terceira semana útil dentro do hiato.
...
recente, agora 28 dias velha, e olhando as 3 categorias juntas, o óleo é a
...
categoria. Com 28 dias de idade, esse corte é o dado de posicionamento mais
...
com treze pregões reais represados e o segundo dia da terceira semana útil
inteira já correndo dentro do gap, o risco de gap de abertura em qualquer
direção só cresce, o que muda a mecânica prática de onde e como esse stop
deveria estar posicionado (um stop lógico numa cotação intradiária pode não
capturar um gap que abre diretamente acima ou abaixo do nível). A leitura de
...
agora dezenove dias corridos de risco de gap sem atualização de preço para
...
agora 68 dias vencida.** A recomendação operacional permanece: exigir
...
ausente mesmo no segundo dia útil da terceira semana do hiato, essa
...
**ISF em 80/100, ISO em 100/100 — ambos inalterados desde pelo menos 25
...
agora 28 dias de idade), o padrão é: farelo com a maior concentração
...
novo há treze pregões reais, com o segundo dia da terceira semana útil do
hiato ainda sem trazer resolução alguma.
...
`vigencia_ate` 2026-07-31) — hoje, terça-feira 25/08, o contador de dias
úteis sem confirmação de status avança de 16 para 17 dias úteis (03, 04, 05,
06, 07, 10, 11, 12, 13, 14, 17, 18, 19, 20, 21, 24 e agora 25/08).** Nenhum
item do RSS desde 06/08 trouxe informação sobre este tema, e o monitor
tributário (`system/tributario_watch.toml`) segue parado desde 2026-06-05 —
**81 dias sem atualização**. **Mecanismo e leitura, sem mudança:** se a
isenção caducou sem renovação, o custo de produção do biodiesel brasileiro
...
última leitura disponível. Com dezessete dias úteis já acumulados sem
verificação e o monitor tributário do próprio sistema parado há 81 dias,
...
vigência formal venceu há 45 dias** (`vigencia_ate` 11/07/2026), sem
...
plena prevista para 01/09/2026, agora a **7 dias**); INDONESIA-B50
...
suporte estrutural. Com a assunção plena a apenas 7 dias e nenhum dado
...
**O monitor tributário como um todo está há 81 dias sem qualquer
atualização** — prioridade de manutenção do sistema, especialmente relevante
agora que a isenção PIS/Cofins acumula 17 dias úteis sem confirmação de
status.
...
**O gap de dado do pipeline segue dentro de sua terceira semana útil
inteira: esta é a 19ª leitura consecutiva escrita sobre o mesmo fechamento
de 06/08, e hoje, terça-feira 25/08, não trouxe dado novo pela vez seguinte.
O job que gera `briefing/latest.md` parece não ter rodado desde 05→06/08,
agora 19 dias corridos exatos e 13 sessões reais de pregão represadas.**
Este é, nesta leitura, um dos pontos de maior severidade de toda a série: um
hiato que atravessa três fins de semana inteiros e já opera dentro do
segundo dia de uma terceira semana de calendário sem qualquer atualização
deixa de ser plausível como "pausa técnica" de rotina e passa a justificar,
por si só, verificação direta e prioritária do pipeline de coleta (fora do
escopo desta leitura, que só pode registrar o fato e recomendar a checagem —
não editar sistema, DB ou config). Enquanto isso não for resolvido, cada
leitura adicional desta série soma apenas dias e sessões ao contador, sem
novo material de mercado para interpretar.

**Quatro forecasts estatísticos internos de 7 dias consecutivos — gerados
em 03, 04, 05 e 06/08, com alvos em 10, 11, 12 e 13/08 — seguem vencidos, um
...
ativo, mas já consumiu, sem possibilidade de recuperação, 19 dos seus 30
dias de janela sem qualquer verificação — quase dois terços do horizonte já
passados sem um único ponto de checagem, e o alvo (05/09) chega antes que o
horizonte inteiro tenha sido testado por dado real caso o hiato persista.

**O COT (CFTC) referente a 04/08/2026 segue ausente, agora 28 dias desde o
...
tese do D+7 (agora 68 dias vencida), ou se rompe para baixo, confirmando-a
com atraso.
...
**A isenção PIS/Cofins do biodiesel acaba de completar o 17º dia útil sem
...
leitura de confirmação, agora há 20 dias** — recomendação de contato direto
com a praça.
...
**O WASDE segue fora da janela deste briefing, agora 46 dias de atraso**
...
Danantara (Indonésia) está marcada para 01/09/2026, agora a 7 dias** — um
...
1. **Todo o preço de mercado (CBOT, câmbio, físico BR) desde 2026-08-06.**
   Esta é a 19ª leitura consecutiva sobre o mesmo fechamento de
   quinta-feira, e hoje — o segundo dia útil dentro da terceira semana útil
   inteira sem dado — confirma que o hiato não é mais uma hipótese de
   "pausa técnica temporária": 19 dias corridos e 13 sessões reais de
   pregão represadas, sem nenhum sinal, no próprio briefing, de que o
   pipeline esteja prestes a normalizar. Esta leitura não tem como saber se
   a soja, o farelo ou o óleo estão hoje acima, abaixo ou no mesmo nível de
   06/08 — toda a análise tática desta leitura (as 4 sessões 03-06/08) é,
   por construção, uma leitura de passado distante, não do presente.
2. **O COT (CFTC), 28 dias desde o último corte** — pelo menos dois ou três
   cortes semanais deveriam ter sido publicados e não aparecem no briefing.
3. **O WASDE, 46 dias de atraso** — o relatório fundamental mais importante
...
4. **O heating oil (HO=F) de 06/08** — abertura idêntica à de 05/08
   ...
   nem confirmada.
5. **O status real da isenção PIS/Cofins do biodiesel** — 17 dias úteis sem
   confirmação, e o monitor tributário do próprio sistema parado há 81 dias
...
7. **O nível de confirmação do salto do físico de farelo no RS** (R$
   1.640→1.800/ton) — uma única leitura, sem segunda confirmação há 20 dias.
8. **MPOB (palma Malásia)** — página acessível, mas sem números extraídos
   ...
   janela nem em nenhuma das dezoito anteriores.
